...
Gem::Specification.new do |s|
  ...
  s.files = [".document".freeze, "BSDL".freeze, "COPYING".freeze, "README.md".freeze, "ext/io/console/console.c".freeze, "ext/io/console/extconf.rb".freeze, "ext/io/console/win32_vk.inc".freeze, "io/console.so".freeze, "lib/console/size.rb".freeze, "lib/ext/io/console/extconf.rb".freeze, "lib/lib/io/console/size.rb".freeze]
