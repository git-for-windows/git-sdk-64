...
Gem::Specification.new do |s|
  ...
  s.files = ["BSDL".freeze, "COPYING".freeze, "README.md".freeze, "ext/zlib/extconf.rb".freeze, "ext/zlib/zlib.c".freeze, "lib/ext/zlib/extconf.rb".freeze, "zlib.gemspec".freeze, "zlib.so".freeze]
