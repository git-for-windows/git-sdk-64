...
#endif
  E_OImode,                /* config/i386/i386-modes.def:105 */
#define HAVE_OImode
#ifdef USE_ENUM_MODES
...
#endif
  E_XImode,                /* config/i386/i386-modes.def:106 */
#define HAVE_XImode
#ifdef USE_ENUM_MODES
...
#endif
  E_P2QImode,              /* config/i386/i386-modes.def:111 */
...
#endif
  E_P2HImode,              /* config/i386/i386-modes.def:112 */
...
#endif
  E_POImode,               /* config/i386/i386-modes.def:117 */
#define HAVE_POImode
#ifdef USE_ENUM_MODES
...
#endif
  E_V2HFmode,              /* config/i386/i386-modes.def:94 */
...
#endif
  E_V2BFmode,              /* config/i386/i386-modes.def:95 */
