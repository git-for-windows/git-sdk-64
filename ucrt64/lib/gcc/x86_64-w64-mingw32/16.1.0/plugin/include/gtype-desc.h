...
#define gt_ggc_m_17stack_local_entry(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_stack_local_entry (X);\
  } while (0)
...
#define gt_ggc_m_17noted_fnptr_store(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_noted_fnptr_store (X);\
  } while (0)
extern void gt_ggc_mx_noted_fnptr_store (void *);
#define gt_ggc_m_30hash_table_noted_fnptr_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_table_noted_fnptr_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_noted_fnptr_hasher_ (void *);
...
#define gt_ggc_m_11extern_list(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_extern_list (X);\
  } while (0)
extern void gt_ggc_mx_extern_list (void *);
#define gt_ggc_m_11export_list(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_export_list (X);\
  } while (0)
extern void gt_ggc_mx_export_list (void *);
#define gt_ggc_m_9stub_list(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_stub_list (X);\
  } while (0)
extern void gt_ggc_mx_stub_list (void *);
#define gt_ggc_m_28hash_table_dllimport_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_table_dllimport_hasher_ (X);\
  } while (0)
...
#define gt_ggc_m_6NODE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_NODE_T (X);\
  } while (0)
extern void gt_ggc_mx_NODE_T (void *);
#define gt_ggc_m_6MOID_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_MOID_T (X);\
  } while (0)
extern void gt_ggc_mx_MOID_T (void *);
#define gt_ggc_m_7GINFO_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_GINFO_T (X);\
  } while (0)
extern void gt_ggc_mx_GINFO_T (void *);
#define gt_ggc_m_9KEYWORD_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_KEYWORD_T (X);\
  } while (0)
extern void gt_ggc_mx_KEYWORD_T (void *);
#define gt_ggc_m_6LINE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_LINE_T (X);\
  } while (0)
extern void gt_ggc_mx_LINE_T (void *);
#define gt_ggc_m_11NODE_INFO_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_NODE_INFO_T (X);\
  } while (0)
extern void gt_ggc_mx_NODE_INFO_T (void *);
#define gt_ggc_m_6PACK_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_PACK_T (X);\
  } while (0)
extern void gt_ggc_mx_PACK_T (void *);
#define gt_ggc_m_6SOID_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_SOID_T (X);\
  } while (0)
extern void gt_ggc_mx_SOID_T (void *);
#define gt_ggc_m_7TABLE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_TABLE_T (X);\
  } while (0)
extern void gt_ggc_mx_TABLE_T (void *);
#define gt_ggc_m_5TAG_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_TAG_T (X);\
  } while (0)
extern void gt_ggc_mx_TAG_T (void *);
#define gt_ggc_m_7TOKEN_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_TOKEN_T (X);\
  } while (0)
extern void gt_ggc_mx_TOKEN_T (void *);
#define gt_ggc_m_11POSTULATE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_POSTULATE_T (X);\
  } while (0)
extern void gt_ggc_mx_POSTULATE_T (void *);
#define gt_ggc_m_9OPTIONS_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_OPTIONS_T (X);\
  } while (0)
extern void gt_ggc_mx_OPTIONS_T (void *);
#define gt_ggc_m_9EXTRACT_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_EXTRACT_T (X);\
  } while (0)
extern void gt_ggc_mx_EXTRACT_T (void *);
#define gt_ggc_m_6MOIF_T(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_MOIF_T (X);\
  } while (0)
extern void gt_ggc_mx_MOIF_T (void *);
#define gt_ggc_m_18vec_MOID_T__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_MOID_T__va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_MOID_T__va_gc_ (void *);
#define gt_ggc_m_21vec_EXTRACT_T__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_EXTRACT_T__va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_EXTRACT_T__va_gc_ (void *);
#define gt_ggc_m_25vec_char__va_gc_vl_embed_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_char__va_gc_vl_embed_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_char__va_gc_vl_embed_ (void *);
#define gt_ggc_m_34hash_map_nofree_string_hash_char__(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_map_nofree_string_hash_char__ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_nofree_string_hash_char__ (void *);
#define gt_ggc_m_5range(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_range (X);\
  } while (0)
extern void gt_ggc_mx_range (void *);
...
#define gt_ggc_m_37vec_c_omp_declare_variant_attr_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_c_omp_declare_variant_attr_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_c_omp_declare_variant_attr_va_gc_ (void *);
...
#define gt_ggc_m_38vec_cp_omp_declare_variant_attr_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_cp_omp_declare_variant_attr_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_cp_omp_declare_variant_attr_va_gc_ (void *);
...
#define gt_ggc_m_46vec_omp_begin_declare_variant_map_entry_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_vec_omp_begin_declare_variant_map_entry_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_omp_begin_declare_variant_map_entry_va_gc_ (void *);
...
#define gt_ggc_m_28hash_map_tree_contract_decl_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_map_tree_contract_decl_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_tree_contract_decl_ (void *);
...
#define gt_pch_n_17stack_local_entry(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_stack_local_entry (X);\
  } while (0)
...
#define gt_pch_n_17noted_fnptr_store(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_noted_fnptr_store (X);\
  } while (0)
extern void gt_pch_nx_noted_fnptr_store (void *);
#define gt_pch_n_30hash_table_noted_fnptr_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_table_noted_fnptr_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_noted_fnptr_hasher_ (void *);
...
#define gt_pch_n_11extern_list(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_extern_list (X);\
  } while (0)
extern void gt_pch_nx_extern_list (void *);
#define gt_pch_n_11export_list(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_export_list (X);\
  } while (0)
extern void gt_pch_nx_export_list (void *);
#define gt_pch_n_9stub_list(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_stub_list (X);\
  } while (0)
extern void gt_pch_nx_stub_list (void *);
#define gt_pch_n_28hash_table_dllimport_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_table_dllimport_hasher_ (X);\
  } while (0)
...
#define gt_pch_n_6NODE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_NODE_T (X);\
  } while (0)
extern void gt_pch_nx_NODE_T (void *);
#define gt_pch_n_6MOID_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_MOID_T (X);\
  } while (0)
extern void gt_pch_nx_MOID_T (void *);
#define gt_pch_n_7GINFO_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_GINFO_T (X);\
  } while (0)
extern void gt_pch_nx_GINFO_T (void *);
#define gt_pch_n_9KEYWORD_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_KEYWORD_T (X);\
  } while (0)
extern void gt_pch_nx_KEYWORD_T (void *);
#define gt_pch_n_6LINE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_LINE_T (X);\
  } while (0)
extern void gt_pch_nx_LINE_T (void *);
#define gt_pch_n_11NODE_INFO_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_NODE_INFO_T (X);\
  } while (0)
extern void gt_pch_nx_NODE_INFO_T (void *);
#define gt_pch_n_6PACK_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_PACK_T (X);\
  } while (0)
extern void gt_pch_nx_PACK_T (void *);
#define gt_pch_n_6SOID_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_SOID_T (X);\
  } while (0)
extern void gt_pch_nx_SOID_T (void *);
#define gt_pch_n_7TABLE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_TABLE_T (X);\
  } while (0)
extern void gt_pch_nx_TABLE_T (void *);
#define gt_pch_n_5TAG_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_TAG_T (X);\
  } while (0)
extern void gt_pch_nx_TAG_T (void *);
#define gt_pch_n_7TOKEN_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_TOKEN_T (X);\
  } while (0)
extern void gt_pch_nx_TOKEN_T (void *);
#define gt_pch_n_11POSTULATE_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_POSTULATE_T (X);\
  } while (0)
extern void gt_pch_nx_POSTULATE_T (void *);
#define gt_pch_n_9OPTIONS_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_OPTIONS_T (X);\
  } while (0)
extern void gt_pch_nx_OPTIONS_T (void *);
#define gt_pch_n_9EXTRACT_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_EXTRACT_T (X);\
  } while (0)
extern void gt_pch_nx_EXTRACT_T (void *);
#define gt_pch_n_6MOIF_T(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_MOIF_T (X);\
  } while (0)
extern void gt_pch_nx_MOIF_T (void *);
#define gt_pch_n_18vec_MOID_T__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_MOID_T__va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_MOID_T__va_gc_ (void *);
#define gt_pch_n_21vec_EXTRACT_T__va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_EXTRACT_T__va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_EXTRACT_T__va_gc_ (void *);
#define gt_pch_n_25vec_char__va_gc_vl_embed_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_char__va_gc_vl_embed_ (X);\
  } while (0)
extern void gt_pch_nx_vec_char__va_gc_vl_embed_ (void *);
#define gt_pch_n_34hash_map_nofree_string_hash_char__(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_map_nofree_string_hash_char__ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_nofree_string_hash_char__ (void *);
#define gt_pch_n_5range(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_range (X);\
  } while (0)
extern void gt_pch_nx_range (void *);
...
#define gt_pch_n_37vec_c_omp_declare_variant_attr_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_c_omp_declare_variant_attr_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_c_omp_declare_variant_attr_va_gc_ (void *);
...
#define gt_pch_n_38vec_cp_omp_declare_variant_attr_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_cp_omp_declare_variant_attr_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_cp_omp_declare_variant_attr_va_gc_ (void *);
...
#define gt_pch_n_46vec_omp_begin_declare_variant_map_entry_va_gc_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_vec_omp_begin_declare_variant_map_entry_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_omp_begin_declare_variant_map_entry_va_gc_ (void *);
...
#define gt_pch_n_28hash_map_tree_contract_decl_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_map_tree_contract_decl_ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_tree_contract_decl_ (void *);
...
extern void gt_pch_p_24ipa_return_value_summary
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_17noted_fnptr_store
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_30hash_table_noted_fnptr_hasher_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_11export_list
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_9stub_list
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_29hash_table_sized_type_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6NODE_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6MOID_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_7GINFO_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_9KEYWORD_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6LINE_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11NODE_INFO_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6PACK_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6SOID_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_7TABLE_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_5TAG_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_7TOKEN_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_11POSTULATE_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_9OPTIONS_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_9EXTRACT_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_6MOIF_T
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_18vec_MOID_T__va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_21vec_EXTRACT_T__va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_25vec_char__va_gc_vl_embed_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_34hash_map_nofree_string_hash_char__
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_5range
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_35vec_c_omp_begin_assumes_data_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_37vec_c_omp_declare_variant_attr_va_gc_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_36vec_cp_omp_begin_assumes_data_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_38vec_cp_omp_declare_variant_attr_va_gc_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_38vec_cp_unparsed_functions_entry_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_46vec_omp_begin_declare_variant_map_entry_va_gc_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_33hash_table_constexpr_call_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_28hash_map_tree_contract_decl_
    (void *, void *, gt_pointer_operator, void *);
