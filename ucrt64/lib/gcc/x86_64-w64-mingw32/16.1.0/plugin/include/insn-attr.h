...
#define HAVE_ATTR_tls64 1
extern enum attr_tls64 get_attr_tls64 (rtx_insn *);
...
#define HAVE_ATTR_addr 1
extern enum attr_addr get_attr_addr (rtx_insn *);
...
#define HAVE_ATTR_has_nf 1
extern enum attr_has_nf get_attr_has_nf (rtx_insn *);
...
#define HAVE_ATTR_nf_subst 1
extern enum attr_nf_subst get_attr_nf_subst (rtx_insn *);
