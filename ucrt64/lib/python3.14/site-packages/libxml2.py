...
def newValidCtxt():
    """Allocate a validation context structure. The public
       function calls related to validity checking. """
...
class xmlNode(xmlCore):
    ...
    def addContent(self, content):
        """NOTE: In contrast to xmlNodeSetContent , content is
...
class xmlDoc(xmlNode):
    ...
    def newEntity(self, name, type, publicId, systemId, content):
        """Like xmlAddDocEntity , but if doc is None or has no
    ...
    def xpathNewContext(self):
        """Create a new xmlXPathContext . Context handling. """
    ...
    def xpathOrderDocElems(self):
        """Call this routine to speed up XPath computation on static
          documents. Evaluation functions. This stamps all the
          element nodes with the document order Like for line
          information, the order is kept in the element->content
          field, the value stored is actually - the node number
          (starting at -1) to be able to differentiate from line
           numbers. """
...
class xpathContext:
    ...
    def xpathContextSetCache(self, active, value, options):
        """If activates XPath objects ( xmlXPathObject ) will be
    ...
    def xpathNewParserContext(self, str):
        """Create a new xmlXPathParserContext . Utilities to extend
           XPath. """
    ...
    def xpathRegisterNs(self, prefix, ns_uri):
        """Register a new namespace. Extending a context. If ns_uri is
           None it unregisters the namespace """
