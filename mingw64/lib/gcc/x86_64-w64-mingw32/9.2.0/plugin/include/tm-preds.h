/* Generated automatically by the program 'E:\mingwbuild\mingw-w64-gcc\src\build-x86_64-w64-mingw32\gcc\build\genpreds.exe'
   from the machine description file '../../gcc-9.2.0/gcc/config/i386/i386.md'.  */
