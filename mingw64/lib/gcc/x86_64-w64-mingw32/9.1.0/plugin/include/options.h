...
enum opt_code
{
  ...
  OPT_fdump_fortran_optimized = 679,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 680,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 681,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 682,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 683,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 684, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 685,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 686,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 687,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 688,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 689,                 /* -fearly-inlining */
  OPT_felide_constructors = 690,             /* -felide-constructors */
  OPT_felide_type = 691,                     /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 692, */    /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 693, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 694,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 695,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 696,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 697,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 698,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 699,                        /* -fenable- */
  OPT_fenforce_eh_specs = 700,               /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 701,                 /* -fenum-int-equiv */
  OPT_fexceptions = 702,                     /* -fexceptions */
  OPT_fexcess_precision_ = 703,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 704,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 705,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 706,           /* -fext-numeric-literals */
  OPT_fextended_identifiers = 707,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 708,                /* -fextern-tls-init */
  OPT_fexternal_blas = 709,                  /* -fexternal-blas */
  OPT_fexternal_templates = 710,             /* -fexternal-templates */
  OPT_ff2c = 711,                            /* -ff2c */
  OPT_ffast_math = 712,                      /* -ffast-math */
  OPT_ffat_lto_objects = 713,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 714,               /* -ffile-prefix-map= */
  OPT_ffinite_math_only = 715,               /* -ffinite-math-only */
  OPT_ffixed_ = 716,                         /* -ffixed- */
  OPT_ffixed_form = 717,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 718,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 719,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 720,                    /* -ffloat-store */
  OPT_ffor_scope = 721,                      /* -ffor-scope */
  /* OPT_fforce_addr = 722, */               /* -fforce-addr */
  OPT_fforward_propagate = 723,              /* -fforward-propagate */
  OPT_ffp_contract_ = 724,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 725,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 726,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 727,                      /* -ffpe-trap= */
  OPT_ffree_form = 728,                      /* -ffree-form */
  OPT_ffree_line_length_ = 729,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 730,          /* -ffree-line-length-none */
  OPT_ffreestanding = 731,                   /* -ffreestanding */
  OPT_ffriend_injection = 732,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 733,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 734,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 735,                   /* -ffunction-cse */
  OPT_ffunction_sections = 736,              /* -ffunction-sections */
  OPT_fgcse = 737,                           /* -fgcse */
  OPT_fgcse_after_reload = 738,              /* -fgcse-after-reload */
  OPT_fgcse_las = 739,                       /* -fgcse-las */
  OPT_fgcse_lm = 740,                        /* -fgcse-lm */
  OPT_fgcse_sm = 741,                        /* -fgcse-sm */
  OPT_fgimple = 742,                         /* -fgimple */
  OPT_fgnat_encodings_ = 743,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 744,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 745,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 746,                         /* -fgnu-tm */
  OPT_fgnu_unique = 747,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 748,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 749,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 750,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 751,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 752,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 753,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 754,          /* -fgo-debug-escape-hash= */
  OPT_fgo_dump_ = 755,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 756,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 757,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 758,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 759,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 760,                       /* -fgraphite */
  OPT_fgraphite_identity = 761,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 762,       /* -fguess-branch-probability */
  OPT_fguiding_decls = 763,                  /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 764, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 765, */                     /* -fhelp */
  /* OPT_fhelp_ = 766, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 767,           /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 768,                      /* -fhonor-std */
  OPT_fhosted = 769,                         /* -fhosted */
  OPT_fhuge_objects = 770,                   /* -fhuge-objects */
  OPT_fident = 771,                          /* -fident */
  OPT_fif_conversion = 772,                  /* -fif-conversion */
  OPT_fif_conversion2 = 773,                 /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 774,         /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 775,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 776,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 777,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 778,             /* -fimplicit-templates */
  OPT_findirect_inlining = 779,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 780,         /* -finhibit-size-directive */
  OPT_finit_character_ = 781,                /* -finit-character= */
  OPT_finit_derived = 782,                   /* -finit-derived */
  OPT_finit_integer_ = 783,                  /* -finit-integer= */
  OPT_finit_local_zero = 784,                /* -finit-local-zero */
  OPT_finit_logical_ = 785,                  /* -finit-logical= */
  OPT_finit_real_ = 786,                     /* -finit-real= */
  OPT_finline = 787,                         /* -finline */
  OPT_finline_atomics = 788,                 /* -finline-atomics */
  OPT_finline_functions = 789,               /* -finline-functions */
  OPT_finline_functions_called_once = 790,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 791, */            /* -finline-limit- */
  OPT_finline_limit_ = 792,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 793,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 794,         /* -finline-small-functions */
  OPT_finput_charset_ = 795,                 /* -finput-charset= */
  OPT_finstrument_functions = 796,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 797,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 798,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 799,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 800,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 801,        /* -fintrinsic-modules-path= */
  OPT_finvariants = 802,                     /* -finvariants */
  OPT_fipa_bit_cp = 803,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 804,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 805, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 806,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 807,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 808,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 809,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 810, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 811,                    /* -fipa-profile */
  OPT_fipa_pta = 812,                        /* -fipa-pta */
  OPT_fipa_pure_const = 813,                 /* -fipa-pure-const */
  OPT_fipa_ra = 814,                         /* -fipa-ra */
  OPT_fipa_reference = 815,                  /* -fipa-reference */
  OPT_fipa_reference_addressable = 816,      /* -fipa-reference-addressable */
  OPT_fipa_sra = 817,                        /* -fipa-sra */
  OPT_fipa_stack_alignment = 818,            /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 819, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 820,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 821,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 822,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 823,              /* -fira-loop-pressure */
  OPT_fira_region_ = 824,                    /* -fira-region= */
  OPT_fira_share_save_slots = 825,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 826,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 827,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 828,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 829,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 830,               /* -fivar-visibility= */
  OPT_fivopts = 831,                         /* -fivopts */
  OPT_fjump_tables = 832,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 833,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 834,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 835,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 836,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 837,          /* -fkeep-static-functions */
  OPT_flabels_ok = 838,                      /* -flabels-ok */
  OPT_flax_vector_conversions = 839,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 840,             /* -fleading-underscore */
  OPT_flifetime_dse = 841,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 842,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 843,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 844,                 /* -flinker-output= */
  /* OPT_flive_patching = 845, */            /* -flive-patching */
  OPT_flive_patching_ = 846,                 /* -flive-patching= */
  OPT_flive_range_shrinkage = 847,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 848,                    /* -flocal-ivars */
  /* OPT_floop_block = 849, */               /* -floop-block */
  /* OPT_floop_flatten = 850, */             /* -floop-flatten */
  OPT_floop_interchange = 851,               /* -floop-interchange */
  OPT_floop_nest_optimize = 852,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 853, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 854,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 855, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 856,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 857,                      /* -flra-remat */
  OPT_flto = 858,                            /* -flto */
  OPT_flto_compression_level_ = 859,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 860,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 861,                 /* -flto-partition= */
  OPT_flto_report = 862,                     /* -flto-report */
  OPT_flto_report_wpa = 863,                 /* -flto-report-wpa */
  OPT_flto_ = 864,                           /* -flto= */
  OPT_fltrans = 865,                         /* -fltrans */
  OPT_fltrans_output_list_ = 866,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 867,              /* -fmacro-prefix-map= */
  OPT_fmain = 868,                           /* -fmain */
  OPT_fmath_errno = 869,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 870,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 871,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 872,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 873,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 874,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 875,                     /* -fmem-report */
  OPT_fmem_report_wpa = 876,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 877,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 878,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 879,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 880,                /* -fmessage-length= */
  OPT_fmodule_file_ = 881,                   /* -fmodule-file= */
  OPT_fmodule_private = 882,                 /* -fmodule-private */
  OPT_fmoduleinfo = 883,                     /* -fmoduleinfo */
  OPT_fmodulo_sched = 884,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 885,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 886,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 887,                  /* -fms-extensions */
  OPT_fmudflap = 888,                        /* -fmudflap */
  OPT_fmudflapir = 889,                      /* -fmudflapir */
  OPT_fmudflapth = 890,                      /* -fmudflapth */
  OPT_fname_mangling_version_ = 891,         /* -fname-mangling-version- */
  OPT_fnew_abi = 892,                        /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 893,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 894,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 895,                   /* -fnext-runtime */
  OPT_fnil_receivers = 896,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 897,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 898,               /* -fnonansi-builtins */
  OPT_fnonnull_objects = 899,                /* -fnonnull-objects */
  OPT_fnothrow_opt = 900,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 901,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 902,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 903,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 904,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 905,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 906,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 907,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 908,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 909,                   /* -foffload-abi= */
  OPT_foffload_ = 910,                       /* -foffload= */
  OPT_fomit_frame_pointer = 911,             /* -fomit-frame-pointer */
  OPT_fonly_ = 912,                          /* -fonly= */
  OPT_fopenacc = 913,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 914,                   /* -fopenacc-dim= */
  OPT_fopenmp = 915,                         /* -fopenmp */
  OPT_fopenmp_simd = 916,                    /* -fopenmp-simd */
  OPT_foperator_names = 917,                 /* -foperator-names */
  OPT_fopt_info = 918,                       /* -fopt-info */
  OPT_fopt_info_ = 919,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 920, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 921,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 922,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 923, */           /* -foptional-diags */
  OPT_fpack_derived = 924,                   /* -fpack-derived */
  OPT_fpack_struct = 925,                    /* -fpack-struct */
  OPT_fpack_struct_ = 926,                   /* -fpack-struct= */
  OPT_fpad_source = 927,                     /* -fpad-source */
  OPT_fpartial_inlining = 928,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 929,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 930,              /* -fpcc-struct-return */
  OPT_fpch_deps = 931,                       /* -fpch-deps */
  OPT_fpch_preprocess = 932,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 933,                     /* -fpeel-loops */
  OPT_fpeephole = 934,                       /* -fpeephole */
  OPT_fpeephole2 = 935,                      /* -fpeephole2 */
  OPT_fpermissive = 936,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 937,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 938,                            /* -fpic */
  OPT_fpie = 939,                            /* -fpie */
  OPT_fplan9_extensions = 940,               /* -fplan9-extensions */
  OPT_fplt = 941,                            /* -fplt */
  OPT_fplugin_arg_ = 942,                    /* -fplugin-arg- */
  OPT_fplugin_ = 943,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 944,            /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 945,                 /* -fpostconditions */
  OPT_fpre_include_ = 946,                   /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 947,             /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 948,                  /* -fpreconditions */
  OPT_fpredictive_commoning = 949,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 950,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 951,                   /* -fpreprocessed */
  OPT_fpretty_templates = 952,               /* -fpretty-templates */
  OPT_fprintf_return_value = 953,            /* -fprintf-return-value */
  OPT_fprofile = 954,                        /* -fprofile */
  OPT_fprofile_abs_path = 955,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 956,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 957,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 958,                   /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 959,         /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 960,          /* -fprofile-filter-files= */
  OPT_fprofile_generate = 961,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 962,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 963,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 964,                 /* -fprofile-report */
  OPT_fprofile_update_ = 965,                /* -fprofile-update= */
  OPT_fprofile_use = 966,                    /* -fprofile-use */
  OPT_fprofile_use_ = 967,                   /* -fprofile-use= */
  OPT_fprofile_values = 968,                 /* -fprofile-values */
  OPT_fprotect_parens = 969,                 /* -fprotect-parens */
  OPT_frandom_seed = 970,                    /* -frandom-seed */
  OPT_frandom_seed_ = 971,                   /* -frandom-seed= */
  OPT_frange_check = 972,                    /* -frange-check */
  OPT_freal_4_real_10 = 973,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 974,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 975,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 976,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 977,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 978,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 979,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 980,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 981,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 982,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 983,                /* -frecord-marker=8 */
  OPT_frecursive = 984,                      /* -frecursive */
  OPT_free = 985,                            /* -free */
  OPT_freg_struct_return = 986,              /* -freg-struct-return */
  /* OPT_fregmove = 987, */                  /* -fregmove */
  OPT_frelease = 988,                        /* -frelease */
  OPT_frename_registers = 989,               /* -frename-registers */
  OPT_freorder_blocks = 990,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 991,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 992,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 993,              /* -freorder-functions */
  OPT_frepack_arrays = 994,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 995,           /* -freplace-objc-classes */
  OPT_frepo = 996,                           /* -frepo */
  OPT_freport_bug = 997,                     /* -freport-bug */
  OPT_frequire_return_statement = 998,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 999,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1000, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1001,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1002,                   /* -fresolution= */
  OPT_frounding_math = 1003,                 /* -frounding-math */
  OPT_frtti = 1004,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1005,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1006,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1007,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1008,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1009,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1010,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1011,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1012,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1013, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1014,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1015,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1016,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1017,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1018,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1019,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1020,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1021,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1022,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1023,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1024,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1025,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1026,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1027,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1028,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1029,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1030, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1031,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1032,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1033,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1034,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1035,               /* -fsection-anchors */
  /* OPT_fsee = 1036, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1037,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1038,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1039,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1040,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1041,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1042,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1043,        /* -fsemantic-interposition */
  OPT_fset_stack_executable = 1044,          /* -fset-stack-executable */
  ...
  /* OPT_ftarget_help = 1095, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1096,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1097, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1098,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1099,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1100,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1101,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1102,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1103,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1104,                   /* -ftime-report */
  OPT_ftime_report_details = 1105,           /* -ftime-report-details */
  OPT_ftls_model_ = 1106,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1107,              /* -ftoplevel-reorder */
  OPT_ftracer = 1108,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1109,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1110,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1111,                   /* -ftrampolines */
  OPT_ftransition_all = 1112,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1113,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1114,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1115,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1116,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1117,              /* -ftransition=field */
  OPT_ftransition_import = 1118,             /* -ftransition=import */
  OPT_ftransition_nogc = 1119,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1120,                /* -ftransition=tls */
  OPT_ftrapping_math = 1121,                 /* -ftrapping-math */
  OPT_ftrapv = 1122,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1123,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1124,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1125,                      /* -ftree-ccp */
  OPT_ftree_ch = 1126,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1127, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1128,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1129,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1130, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1131,                   /* -ftree-cselim */
  OPT_ftree_dce = 1132,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1133,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1134,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1135,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1136,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1137, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1138,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1139,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1140, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1141,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1142,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1143, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1144,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1145,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1146,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1147,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1148,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1149,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1150,                      /* -ftree-pre */
  OPT_ftree_pta = 1151,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1152,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1153, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1154,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1155,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1156,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1157,                     /* -ftree-slsr */
  OPT_ftree_sra = 1158,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1159, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1160, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1161,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1162,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1163,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1164, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1165,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1166, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1167,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1168,         /* -funconstrained-commons */
  OPT_funderscoring = 1169,                  /* -funderscoring */
  OPT_funit_at_a_time = 1170,                /* -funit-at-a-time */
  OPT_funittest = 1171,                      /* -funittest */
  OPT_funroll_all_loops = 1172,              /* -funroll-all-loops */
  OPT_funroll_loops = 1173,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1174, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1175,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1176,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1177,                 /* -funsigned-char */
  OPT_funswitch_loops = 1178,                /* -funswitch-loops */
  OPT_funwind_tables = 1179,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1180,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1181,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1182,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1183,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1184,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1185,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1186,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1187,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1188,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1189,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1190,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1191, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1192,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1193,                   /* -fverbose-asm */
  /* OPT_fversion = 1194, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1195,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1196,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1197,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1198,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1199,                   /* -fvisibility= */
  OPT_fvpt = 1200,                           /* -fvpt */
  OPT_fvtable_gc = 1201,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1202,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1203,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1204,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1205,                     /* -fvtv-debug */
  OPT_fweak = 1206,                          /* -fweak */
  OPT_fweb = 1207,                           /* -fweb */
  /* OPT_fwhole_file = 1208, */              /* -fwhole-file */
  OPT_fwhole_program = 1209,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1210,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1211,             /* -fworking-directory */
  OPT_fwpa = 1212,                           /* -fwpa */
  OPT_fwpa_ = 1213,                          /* -fwpa= */
  OPT_fwrapv = 1214,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1215,                 /* -fwrapv-pointer */
  OPT_fwritable_relocated_rdata = 1216,      /* -fwritable-relocated-rdata */
  OPT_fxref = 1217,                          /* -fxref */
  /* OPT_fzee = 1218, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1219,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1220,                     /* -fzero-link */
  OPT_g = 1221,                              /* -g */
  OPT_gant = 1222,                           /* -gant */
  OPT_gas_loc_support = 1223,                /* -gas-loc-support */
  OPT_gas_locview_support = 1224,            /* -gas-locview-support */
  OPT_gcoff = 1225,                          /* -gcoff */
  OPT_gcoff1 = 1226,                         /* -gcoff1 */
  OPT_gcoff2 = 1227,                         /* -gcoff2 */
  OPT_gcoff3 = 1228,                         /* -gcoff3 */
  OPT_gcolumn_info = 1229,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1230,                 /* -gdescribe-dies */
  OPT_gdwarf = 1231,                         /* -gdwarf */
  OPT_gdwarf_ = 1232,                        /* -gdwarf- */
  OPT_gen_decls = 1233,                      /* -gen-decls */
  OPT_ggdb = 1234,                           /* -ggdb */
  OPT_ggnu_pubnames = 1235,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1236,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1237, /* -ginternal-reset-location-views */
  OPT_gnat = 1238,                           /* -gnat */
  OPT_gnatO = 1239,                          /* -gnatO */
  OPT_gno_ = 1240,                           /* -gno- */
  OPT_gno_pubnames = 1241,                   /* -gno-pubnames */
  OPT_gpubnames = 1242,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1243,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1244,                   /* -gsplit-dwarf */
  OPT_gstabs = 1245,                         /* -gstabs */
  OPT_gstabs_ = 1246,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1247,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1248,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1249,                        /* -gtoggle */
  OPT_gvariable_location_views = 1250,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1251,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1252,                           /* -gvms */
  OPT_gxcoff = 1253,                         /* -gxcoff */
  OPT_gxcoff_ = 1254,                        /* -gxcoff+ */
  OPT_gz = 1255,                             /* -gz */
  OPT_gz_ = 1256,                            /* -gz= */
  OPT_h = 1257,                              /* -h */
  OPT_idirafter = 1258,                      /* -idirafter */
  OPT_imacros = 1259,                        /* -imacros */
  OPT_imultiarch = 1260,                     /* -imultiarch */
  OPT_imultilib = 1261,                      /* -imultilib */
  OPT_include = 1262,                        /* -include */
  OPT_iplugindir_ = 1263,                    /* -iplugindir= */
  OPT_iprefix = 1264,                        /* -iprefix */
  OPT_iquote = 1265,                         /* -iquote */
  OPT_isysroot = 1266,                       /* -isysroot */
  OPT_isystem = 1267,                        /* -isystem */
  OPT_iwithprefix = 1268,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1269,              /* -iwithprefixbefore */
  OPT_k8 = 1270,                             /* -k8 */
  OPT_l = 1271,                              /* -l */
  OPT_lang_asm = 1272,                       /* -lang-asm */
  OPT_m128bit_long_double = 1273,            /* -m128bit-long-double */
  OPT_m16 = 1274,                            /* -m16 */
  OPT_m32 = 1275,                            /* -m32 */
  OPT_m3dnow = 1276,                         /* -m3dnow */
  OPT_m3dnowa = 1277,                        /* -m3dnowa */
  OPT_m64 = 1278,                            /* -m64 */
  OPT_m80387 = 1279,                         /* -m80387 */
  OPT_m8bit_idiv = 1280,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1281,             /* -m96bit-long-double */
  OPT_mabi_ = 1282,                          /* -mabi= */
  OPT_mabm = 1283,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1284,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1285,                 /* -maddress-mode= */
  OPT_madx = 1286,                           /* -madx */
  OPT_maes = 1287,                           /* -maes */
  OPT_malign_data_ = 1288,                   /* -malign-data= */
  OPT_malign_double = 1289,                  /* -malign-double */
  OPT_malign_functions_ = 1290,              /* -malign-functions= */
  OPT_malign_jumps_ = 1291,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1292,                  /* -malign-loops= */
  OPT_malign_stringops = 1293,               /* -malign-stringops */
  OPT_march_ = 1294,                         /* -march= */
  OPT_masm_ = 1295,                          /* -masm= */
  OPT_mavx = 1296,                           /* -mavx */
  OPT_mavx2 = 1297,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1298,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1299,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1300,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1301,                  /* -mavx5124vnniw */
  OPT_mavx512bitalg = 1302,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1303,                      /* -mavx512bw */
  OPT_mavx512cd = 1304,                      /* -mavx512cd */
  OPT_mavx512dq = 1305,                      /* -mavx512dq */
  OPT_mavx512er = 1306,                      /* -mavx512er */
  OPT_mavx512f = 1307,                       /* -mavx512f */
  OPT_mavx512ifma = 1308,                    /* -mavx512ifma */
  OPT_mavx512pf = 1309,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1310,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1311,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1312,                      /* -mavx512vl */
  OPT_mavx512vnni = 1313,                    /* -mavx512vnni */
  OPT_mavx512vpopcntdq = 1314,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1315,                           /* -mbmi */
  OPT_mbmi2 = 1316,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1317,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1318,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1319,                    /* -mcet-switch */
  OPT_mcld = 1320,                           /* -mcld */
  OPT_mcldemote = 1321,                      /* -mcldemote */
  OPT_mclflushopt = 1322,                    /* -mclflushopt */
  OPT_mclwb = 1323,                          /* -mclwb */
  OPT_mclzero = 1324,                        /* -mclzero */
  OPT_mcmodel_ = 1325,                       /* -mcmodel= */
  OPT_mconsole = 1326,                       /* -mconsole */
  /* OPT_mcpu_ = 1327, */                    /* -mcpu= */
  OPT_mcrc32 = 1328,                         /* -mcrc32 */
  OPT_mcrtdll_ = 1329,                       /* -mcrtdll= */
  OPT_mcx16 = 1330,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1331,            /* -mdispatch-scheduler */
  OPT_mdll = 1332,                           /* -mdll */
  ...
  OPT_mhard_float = 1351,                    /* -mhard-float */
  OPT_mhle = 1352,                           /* -mhle */
  OPT_miamcu = 1353,                         /* -miamcu */
  OPT_mieee_fp = 1354,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1355,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1356,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1357,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1358,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1359,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1360,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1361, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1362,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1363,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1364,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1365,                /* -mlong-double-80 */
  OPT_mlwp = 1366,                           /* -mlwp */
  OPT_mlzcnt = 1367,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1368,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1369,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1370,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1371,                  /* -mmitigate-rop */
  OPT_mmmx = 1372,                           /* -mmmx */
  OPT_mmovbe = 1373,                         /* -mmovbe */
  OPT_mmovdir64b = 1374,                     /* -mmovdir64b */
  OPT_mmovdiri = 1375,                       /* -mmovdiri */
  OPT_mmpx = 1376,                           /* -mmpx */
  OPT_mms_bitfields = 1377,                  /* -mms-bitfields */
  OPT_mmwaitx = 1378,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1379,            /* -mno-align-stringops */
  OPT_mno_default = 1380,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1381,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1382,                  /* -mno-push-args */
  OPT_mno_red_zone = 1383,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1384,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1385,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1386,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1387,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1388,                          /* -mpc32 */
  OPT_mpc64 = 1389,                          /* -mpc64 */
  OPT_mpc80 = 1390,                          /* -mpc80 */
  OPT_mpclmul = 1391,                        /* -mpclmul */
  OPT_mpcommit = 1392,                       /* -mpcommit */
  OPT_mpconfig = 1393,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1394,            /* -mpe-aligned-commons */
  OPT_mpku = 1395,                           /* -mpku */
  ...
  OPT_mstv = 1439,                           /* -mstv */
  OPT_mtbm = 1440,                           /* -mtbm */
  OPT_mthreads = 1441,                       /* -mthreads */
  OPT_mtls_dialect_ = 1442,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1443,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1444,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1445,                         /* -mtune= */
  OPT_municode = 1446,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1447,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1448,                          /* -mvaes */
  OPT_mveclibabi_ = 1449,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1450,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1451,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1452,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1453,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1454,                      /* -mwbnoinvd */
  OPT_mwin32 = 1455,                         /* -mwin32 */
  OPT_mwindows = 1456,                       /* -mwindows */
  OPT_mx32 = 1457,                           /* -mx32 */
  OPT_mxop = 1458,                           /* -mxop */
  OPT_mxsave = 1459,                         /* -mxsave */
  OPT_mxsavec = 1460,                        /* -mxsavec */
  OPT_mxsaveopt = 1461,                      /* -mxsaveopt */
  OPT_mxsaves = 1462,                        /* -mxsaves */
  OPT_n = 1463,                              /* -n */
  OPT_no_canonical_prefixes = 1464,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1465,              /* -no-integrated-cpp */
  OPT_no_pie = 1466,                         /* -no-pie */
  OPT_no_pthread = 1467,                     /* -no-pthread */
  OPT_nocpp = 1468,                          /* -nocpp */
  OPT_nodefaultlibs = 1469,                  /* -nodefaultlibs */
  OPT_nolibc = 1470,                         /* -nolibc */
  OPT_nophoboslib = 1471,                    /* -nophoboslib */
  OPT_nostartfiles = 1472,                   /* -nostartfiles */
  OPT_nostdinc = 1473,                       /* -nostdinc */
  OPT_nostdinc__ = 1474,                     /* -nostdinc++ */
  OPT_nostdlib = 1475,                       /* -nostdlib */
  OPT_o = 1476,                              /* -o */
  OPT_p = 1477,                              /* -p */
  OPT_pass_exit_codes = 1478,                /* -pass-exit-codes */
  /* OPT_pedantic = 1479, */                 /* -pedantic */
  OPT_pedantic_errors = 1480,                /* -pedantic-errors */
  OPT_pg = 1481,                             /* -pg */
  OPT_pie = 1482,                            /* -pie */
  OPT_pipe = 1483,                           /* -pipe */
  OPT_posix = 1484,                          /* -posix */
  OPT_print_file_name_ = 1485,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1486,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1487,          /* -print-multi-directory */
  OPT_print_multi_lib = 1488,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1489,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1490,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1491,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1492,               /* -print-prog-name= */
  OPT_print_search_dirs = 1493,              /* -print-search-dirs */
  OPT_print_sysroot = 1494,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1495,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1496,                        /* -pthread */
  OPT_quiet = 1497,                          /* -quiet */
  OPT_r = 1498,                              /* -r */
  OPT_remap = 1499,                          /* -remap */
  OPT_s = 1500,                              /* -s */
  OPT_save_temps = 1501,                     /* -save-temps */
  OPT_save_temps_ = 1502,                    /* -save-temps= */
  OPT_shared = 1503,                         /* -shared */
  OPT_shared_libgcc = 1504,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1505,               /* -shared-libphobos */
  /* OPT_specs = 1506, */                    /* -specs */
  OPT_specs_ = 1507,                         /* -specs= */
  OPT_static = 1508,                         /* -static */
  OPT_static_libasan = 1509,                 /* -static-libasan */
  OPT_static_libgcc = 1510,                  /* -static-libgcc */
  OPT_static_libgfortran = 1511,             /* -static-libgfortran */
  OPT_static_libgo = 1512,                   /* -static-libgo */
  OPT_static_liblsan = 1513,                 /* -static-liblsan */
  OPT_static_libmpx = 1514,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1515,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1516,               /* -static-libphobos */
  OPT_static_libstdc__ = 1517,               /* -static-libstdc++ */
  OPT_static_libtsan = 1518,                 /* -static-libtsan */
  OPT_static_libubsan = 1519,                /* -static-libubsan */
  OPT_static_pie = 1520,                     /* -static-pie */
  /* OPT_std_c__03 = 1521, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1522, */                /* -std=c++0x */
  OPT_std_c__11 = 1523,                      /* -std=c++11 */
  OPT_std_c__14 = 1524,                      /* -std=c++14 */
  OPT_std_c__17 = 1525,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1526, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1527, */                /* -std=c++1z */
  OPT_std_c__2a = 1528,                      /* -std=c++2a */
  OPT_std_c__98 = 1529,                      /* -std=c++98 */
  OPT_std_c11 = 1530,                        /* -std=c11 */
  OPT_std_c17 = 1531,                        /* -std=c17 */
  /* OPT_std_c18 = 1532, */                  /* -std=c18 */
  /* OPT_std_c1x = 1533, */                  /* -std=c1x */
  OPT_std_c2x = 1534,                        /* -std=c2x */
  /* OPT_std_c89 = 1535, */                  /* -std=c89 */
  OPT_std_c90 = 1536,                        /* -std=c90 */
  OPT_std_c99 = 1537,                        /* -std=c99 */
  /* OPT_std_c9x = 1538, */                  /* -std=c9x */
  OPT_std_f2003 = 1539,                      /* -std=f2003 */
  OPT_std_f2008 = 1540,                      /* -std=f2008 */
  OPT_std_f2008ts = 1541,                    /* -std=f2008ts */
  OPT_std_f2018 = 1542,                      /* -std=f2018 */
  OPT_std_f95 = 1543,                        /* -std=f95 */
  OPT_std_gnu = 1544,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1545, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1546, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1547,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1548,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1549,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1550, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1551, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1552,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1553,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1554,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1555,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1556, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1557, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1558,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1559, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1560,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1561,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1562, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1563, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1564,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1565, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1566, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1567, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1568, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1569, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1570,                     /* -std=legacy */
  OPT_symbolic = 1571,                       /* -symbolic */
  OPT_t = 1572,                              /* -t */
  OPT_time = 1573,                           /* -time */
  OPT_time_ = 1574,                          /* -time= */
  OPT_traditional = 1575,                    /* -traditional */
  OPT_traditional_cpp = 1576,                /* -traditional-cpp */
  OPT_trigraphs = 1577,                      /* -trigraphs */
  OPT_u = 1578,                              /* -u */
  OPT_undef = 1579,                          /* -undef */
  OPT_v = 1580,                              /* -v */
  OPT_version = 1581,                        /* -version */
  OPT_w = 1582,                              /* -w */
  OPT_wrapper = 1583,                        /* -wrapper */
  OPT_x = 1584,                              /* -x */
  OPT_z = 1585,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
