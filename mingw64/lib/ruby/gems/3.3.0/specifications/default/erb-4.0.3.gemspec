...
Gem::Specification.new do |s|
  ...
  s.files = ["erb.rb".freeze, "erb/compiler.rb".freeze, "erb/def_method.rb".freeze, "erb/util.rb".freeze, "erb/version.rb".freeze, "ext/erb/escape/extconf.rb".freeze, "libexec/erb".freeze]
