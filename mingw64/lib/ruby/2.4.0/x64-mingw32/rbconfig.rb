...
module RbConfig
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "x86_64-w64-mingw32-gcc.exe (Rev1, Built by MSYS2 project) 6.3.0\nCopyright (C) 2016 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=x86-64 -mtune=generic -O2 -pipe -I/mingw64/include/ncurses -IC:/building/msys64/mingw64/lib/libffi-3.2.1/include"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048 -IC:/building/msys64/mingw64/lib/libffi-3.2.1/include -I/mingw64/include/ncurses -D_WIN32_WINNT=0x0501 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -pipe"
  CONFIG["CFLAGS"] = "-march=x86-64 -mtune=generic -O2 -pipe -I/mingw64/include/ncurses -IC:/building/msys64/mingw64/lib/libffi-3.2.1/include"
