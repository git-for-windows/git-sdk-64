...
module RbConfig
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=nocona -msahf -mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -I/mingw64/include/pdcurses "
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,--no-as-needed"
