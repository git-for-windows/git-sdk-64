...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -march=x86-64 '
           ...
           '-DNDEBUG -march=x86-64 -mtune=generic -O2 -pipe -fwrapv '
           '-D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFIGURE_CPPFLAGS': '-I../Python-3.6.4/PC -D_FORTIFY_SOURCE=2 '
 ...
 'CONFIG_ARGS': "'--prefix=/mingw64' '--host=x86_64-w64-mingw32' "
                ...
                "'--with-threads' '--with-system-expat' '--with-system-ffi' "
                "'--without-ensurepip' 'OPT=' 'build_alias=x86_64-w64-mingw32' "
                "'host_alias=x86_64-w64-mingw32' 'CFLAGS=-march=x86-64 "
                '-mtune=generic -O2 -pipe -fwrapv -D__USE_MINGW_ANSI_STDIO=1  '
                "-DNDEBUG ' 'LDFLAGS=-pipe -s ' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 "
                '-D__USE_MINGW_ANSI_STDIO=1 '
 ...
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Python-3.6.4/Include '
             '-I../Python-3.6.4/PC -D_FORTIFY_SOURCE=2 '
             '-D__USE_MINGW_ANSI_STDIO=1 '
             '-IC:/building/msys64/mingw64/include/ncursesw  -I. '
 ...
 'LIBPL': '/lib/python3.6/config-3.6m',
 ...
 'MAKESETUP': '../Python-3.6.4/Modules/makesetup',
 'MANDIR': sys.prefix + '/share/man',
 'MKDIR_P': '/usr/bin/mkdir -p',
 'MODLIBS': '-lws2_32',
 'MODNAMES': 'nt _thread winreg msvcrt _winapi errno _sre _codecs _weakref '
             '_functools _operator _collections itertools atexit _signal _stat '
             'time _locale _io zipimport faulthandler _tracemalloc _symtable '
             'xxsubtype',
 'MODOBJS': 'Modules/posixmodule.o  Modules/_threadmodule.o  Modules/winreg.o  '
            'Modules/msvcrtmodule.o  Modules/_winapi.o  Modules/errnomodule.o  '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -march=x86-64 '
                   ...
                   '-D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG -march=x86-64 '
                   '-mtune=generic -O2 -pipe -fwrapv '
                   '-D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -IObjects -IInclude '
                   '-IPython -I. -I../Python-3.6.4/Include '
                   '-I../Python-3.6.4/PC -D_FORTIFY_SOURCE=2 '
                   '-D__USE_MINGW_ANSI_STDIO=1 '
                   '-IC:/building/msys64/mingw64/include/ncursesw  -I. '
                   '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
                   '-IC:/building/msys64/mingw64/include/ncursesw  '
                   '-DPy_BUILD_CORE -D_WIN32_WINNT=0x0601',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Python-3.6.4/Include '
                '-I../Python-3.6.4/PC -D_FORTIFY_SOURCE=2 '
                '-D__USE_MINGW_ANSI_STDIO=1 '
                '-IC:/building/msys64/mingw64/include/ncursesw  -I. '
                '-D_FORTIFY_SOURCE=2 -D__USE_MINGW_ANSI_STDIO=1 '
 ...
 'SRC_GDB_HOOKS': '../Python-3.6.4/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python.exe ../Python-3.6.4/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3.6 ../Python-3.6.4/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'USE_INLINE': 1,
 'VERSION': '3.6',
 'VPATH': 'C:/repo/mingw-w64-python3/src/Python-3.6.4',
 'VPATH_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.6.4',
 ...
 'abs_srcdir': 'C:/repo/mingw-w64-python3/src/Python-3.6.4',
 'abs_srcdir_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.6.4',
 'datarootdir': sys.prefix + '/share',
 'exec_prefix': sys.prefix,
 'prefix': 'C:/building/msys64/mingw64',
 'prefix_b2h': 'C:/building/msys64/mingw64',
 'srcdir': 'C:/repo/mingw-w64-python3/src/Python-3.6.4',
 'srcdir_b2h': 'C:/repo/mingw-w64-python3/src/Python-3.6.4'}
