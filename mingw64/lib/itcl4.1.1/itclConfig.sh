...
# build directory.
itcl_BUILD_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litcl411'
ITCL_BUILD_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litcl411'

# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litcl411'
ITCL_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litcl411'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litclstub411'
ITCL_BUILD_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litclstub411'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litclstub411'
ITCL_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.1.1 -litclstub411'

# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='/mingw64/lib/itcl4.1.1/libitclstub411.a'
ITCL_BUILD_STUB_LIB_PATH='/mingw64/lib/itcl4.1.1/libitclstub411.a'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/mingw64/lib/itcl4.1.1/libitclstub411.a'
ITCL_STUB_LIB_PATH='/mingw64/lib/itcl4.1.1/libitclstub411.a'
