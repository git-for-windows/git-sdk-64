...
# build directory.
itcl_BUILD_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litcl404'
ITCL_BUILD_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litcl404'

# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litcl404'
ITCL_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litcl404'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litclstub404'
ITCL_BUILD_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litclstub404'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litclstub404'
ITCL_STUB_LIB_SPEC='-L/mingw64/lib/itcl4.0.4 -litclstub404'

# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='/mingw64/lib/itcl4.0.4/libitclstub404.a'
ITCL_BUILD_STUB_LIB_PATH='/mingw64/lib/itcl4.0.4/libitclstub404.a'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/mingw64/lib/itcl4.0.4/libitclstub404.a'
ITCL_STUB_LIB_PATH='/mingw64/lib/itcl4.0.4/libitclstub404.a'
