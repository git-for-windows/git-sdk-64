...
<code class="literal">git clone &lt;repo&gt;</code>, you can either use:</p>
...
<div class="variablelist"><dl class="variablelist"><dt><span class="term"><code class="literal">git branch</code></span></dt><dd>
list all branches.
</dd><dt><span class="term"><code class="literal">git branch &lt;branch&gt;</code></span></dt><dd>
create a new branch named <code class="literal">&lt;branch&gt;</code>, referencing the same
point in history as the current branch.
</dd><dt><span class="term"><code class="literal">git branch &lt;branch&gt; &lt;start-point&gt;</code></span></dt><dd>
...
</dd><dt><span class="term"><code class="literal">git branch -d &lt;branch&gt;</code></span></dt><dd>
...
</dd><dt><span class="term"><code class="literal">git switch &lt;branch&gt;</code></span></dt><dd>
...
</dd><dt><span class="term"><code class="literal">git switch -c &lt;new&gt; &lt;start-point&gt;</code></span></dt><dd>
...
<p>The <code class="literal">git switch</code> command normally expects a branch head, but will also
...
that you gave <code class="literal">git remote add</code>, in this case <code class="literal">staging</code>:</p>
<pre class="screen">$ git branch -r
...
<p>If you run <code class="literal">git fetch &lt;remote&gt;</code> later, the remote-tracking branches
for the named <code class="literal">&lt;remote&gt;</code> will be updated.</p>
...
<p>If you run <code class="literal">git branch</code> at this point, you’ll see that Git has
...
<p>Note that the version which <code class="literal">git bisect</code> checks out for you at each
...
<p>then test, run <code class="literal">bisect good</code> or <code class="literal">bisect bad</code> as appropriate, and
continue.</p>
<p>Instead of <code class="literal">git bisect visualize</code> and then <code class="literal">git reset --hard
...
<p>The <code class="literal">git fetch</code> operation always stores the head of the last fetched
...
$ git rev-list master
e05db0fd4f31dde7005f075a84f96b360d05984b</pre>
<p>Or you could recall that the <code class="literal">...</code> operator selects all commits
...
<p>Note that <code class="literal">git add</code> always adds just the current contents of a file
to the index; further changes to the same file will be ignored unless
you run <code class="literal">git add</code> on the file again.</p>
...
<code class="literal">git status</code>.</p>
...
<code class="literal">git diff</code> will (by default) no longer show diffs for that file.</p>
</div>
</div>
...
state with</p>
<pre class="screen">$ git restore --staged --worktree :/</pre>
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="reverting-a-commit"></a>Fixing a mistake with a new commit</h3></div></div></div>
...
<pre class="screen">$ git revert HEAD</pre>
...
conflicts manually, just as in the case of <a class="link" href="#resolving-a-merge" title="Resolving a merge">resolving a merge</a>.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="fixing-a-mistake-by-rewriting-history"></a>Fixing a mistake by rewriting history</h3></div></div></div>

<p>If the problematic commit is the most recent commit, and you have not
yet made that commit public, then you may just
<a class="link" href="#undoing-a-merge" title="Undoing a merge">destroy it using <code class="literal">git reset</code></a>.</p>
<p>Alternatively, you
can edit the working directory and update the index to fix your
mistake, just as if you were going to <a class="link" href="#how-to-make-a-commit" title="How to make a commit">create a
new commit</a>, then run</p>
<pre class="screen">$ git commit --amend</pre>
<p>which will replace the old commit by a new commit incorporating your
changes, giving you a chance to edit the old commit message first.</p>
<p>Again, you should never do this to a commit that may already have
...
<p>In the process of undoing a previous bad change, you may find it
useful to check out an older version of a particular file using
<a class="ulink" href="git-restore.html" target="_top">git-restore(1)</a>. The command</p>
<pre class="screen">$ git restore --source=HEAD^ path/to/file</pre>
<p>replaces path/to/file by the contents it had in the commit HEAD^, and
also updates the index to match.  It does not change branches.</p>
<p>If you just want to look at an old version of the file, without
modifying the working directory, you can do that with
<a class="ulink" href="git-show.html" target="_top">git-show(1)</a>:</p>
<pre class="screen">$ git show HEAD^:path/to/file</pre>
<p>which will display the given version of the file.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="interrupted-work"></a>Temporarily setting aside work in progress</h3></div></div></div>

<p>While you are in the middle of working on something complicated, you
...
<pre class="screen">$ git stash push -m "work in progress for foo feature"</pre>
<p>This command will save your changes away to the <code class="literal">stash</code>, and
reset your working tree and the index to match the tip of your
current branch.  Then you can make your fix as usual.</p>
<pre class="screen">... edit and test ...
$ git commit -a -m "blorpl: typofix"</pre>
<p>After that, you can go back to what you were working on with
<code class="literal">git stash pop</code>:</p>
<pre class="screen">$ git stash pop</pre>
</div>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="ensuring-good-performance"></a>Ensuring good performance</h2></div></div></div>

<p>On large repositories, Git depends on compression to keep the history
...
to avoid automatic compression kicking in when it is not convenient.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="ensuring-reliability"></a>Ensuring reliability</h2></div></div></div>

<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="checking-for-corruption"></a>Checking the repository for corruption</h3></div></div></div>

<p>The <a class="ulink" href="git-fsck.html" target="_top">git-fsck(1)</a> command runs a number of self-consistency checks
on the repository, and reports on any problems.  This may take some
time.</p>
<pre class="screen">$ git fsck
...
...</pre>
<p>You will see informational messages on dangling objects. They are objects
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="recovering-lost-changes"></a>Recovering lost changes</h3></div></div></div>

<div class="section"><div class="titlepage"><div><div><h4 class="title"><a name="reflogs"></a>Reflogs</h4></div></div></div>

<p>Say you modify a branch with <a class="link" href="#fixing-mistakes" title="Fixing mistakes"><code class="literal">git reset --hard</code></a>,
and then realize that the branch was the only reference you had to
that point in history.</p>
<p>Fortunately, Git also keeps a log, called a "reflog", of all the
previous values of each branch.  So in this case you can still find the
old history using, for example,</p>
<pre class="screen">$ git log master@{1}</pre>
<p>This lists the commits reachable from the previous version of the
<code class="literal">master</code> branch head.  This syntax can be used with any Git command
that accepts a commit, not just with <code class="literal">git log</code>.  Some other examples:</p>
<pre class="screen">$ git show master@{2}           # See where the branch pointed 2,
$ git show master@{3}           # 3, ... changes ago.
$ gitk master@{yesterday}       # See where it pointed yesterday,
$ gitk master@{"1 week ago"}    # ... or last week
$ git log --walk-reflogs master # show reflog entries for master</pre>
<p>A separate reflog is kept for the HEAD, so</p>
<pre class="screen">$ git show HEAD@{"1 week ago"}</pre>
<p>will show what HEAD pointed to one week ago, not what the current branch
pointed to one week ago.  This allows you to see the history of what
you’ve checked out.</p>
<p>The reflogs are kept by default for 30 days, after which they may be
...
section of <a class="ulink" href="gitrevisions.html" target="_top">gitrevisions(7)</a> for details.</p>
<p>Note that the reflog history is very different from normal Git history.
While normal history is shared by every repository that works on the
same project, the reflog history is not shared: it tells you only about
how the branches in your local repository have changed over time.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h4 class="title"><a name="dangling-object-recovery"></a>Examining dangling objects</h4></div></div></div>

<p>In some situations the reflog may not be able to save you.  For example,
suppose you delete a branch, then realize you need the history it
contained.  The reflog is also deleted; however, if you have not yet
pruned the repository, then you may still be able to find the lost
commits in the dangling objects that <code class="literal">git fsck</code> reports.  See
<a class="xref" href="#dangling-objects" title="Dangling objects">the section called “Dangling objects”</a> for the details.</p>
<pre class="screen">$ git fsck
dangling commit 7281251ddd2a61e38657c827739c57015671a6b3
dangling commit 2706a059f258c6b245f298dc4ff2ccd30ec21a63
dangling commit 13472b7c4b80851a1bc551779171dcb03655e9b5
...</pre>
<p>You can examine
one of those dangling commits with, for example,</p>
<pre class="screen">$ gitk 7281251ddd --not --all</pre>
<p>which does what it sounds like: it says that you want to see the commit
...
and complex commit history that was dropped.)</p>
<p>If you decide you want the history back, you can always create a new
reference pointing to it, for example, a new branch:</p>
<pre class="screen">$ git branch recovered-branch 7281251ddd</pre>
<p>Other types of dangling objects (blobs and trees) are also possible, and
dangling objects can arise in other situations.</p>
</div>
</div>
</div>
</div>
<div class="chapter"><div class="titlepage"><div><div><h1 class="title"><a name="sharing-development"></a>Chapter 4. Sharing development with others</h1></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl class="toc"><dt><span class="section"><a href="#getting-updates-With-git-pull">Getting updates with git pull</a></span></dt><dt><span class="section"><a href="#submitting-patches">Submitting patches to a project</a></span></dt><dt><span class="section"><a href="#importing-patches">Importing patches to a project</a></span></dt><dt><span class="section"><a href="#public-repositories">Public Git repositories</a></span></dt><dd><dl><dt><span class="section"><a href="#setting-up-a-public-repository">Setting up a public repository</a></span></dt><dt><span class="section"><a href="#exporting-via-git">Exporting a Git repository via the Git protocol</a></span></dt><dt><span class="section"><a href="#exporting-via-http">Exporting a git repository via HTTP</a></span></dt><dt><span class="section"><a href="#pushing-changes-to-a-public-repository">Pushing changes to a public repository</a></span></dt><dt><span class="section"><a href="#forcing-push">What to do when a push fails</a></span></dt><dt><span class="section"><a href="#setting-up-a-shared-repository">Setting up a shared repository</a></span></dt><dt><span class="section"><a href="#setting-up-gitweb">Allowing web browsing of a repository</a></span></dt></dl></dd><dt><span class="section"><a href="#how-to-get-a-git-repository-with-minimal-history">How to get a Git repository with minimal history</a></span></dt><dt><span class="section"><a href="#sharing-development-examples">Examples</a></span></dt><dd><dl><dt><span class="section"><a href="#maintaining-topic-branches">Maintaining topic branches for a Linux subsystem maintainer</a></span></dt></dl></dd></dl></div>
...
<p>We have already seen <a class="link" href="#Updating-a-repository-With-git-fetch" title="Updating a repository with git fetch">how to
keep remote-tracking branches up to date</a> with <a class="ulink" href="git-fetch.html" target="_top">git-fetch(1)</a>,
and how to merge two branches.  So you can merge in changes from the
original repository’s master branch with:</p>
<pre class="screen">$ git fetch
$ git merge origin/master</pre>
<p>However, the <a class="ulink" href="git-pull.html" target="_top">git-pull(1)</a> command provides a way to do this in
one step:</p>
<pre class="screen">$ git pull origin master</pre>
<p>In fact, if you have <code class="literal">master</code> checked out, then this branch has been
configured by <code class="literal">git clone</code> to get changes from the HEAD branch of the
origin repository.  So often you can
accomplish the above with just a simple</p>
<pre class="screen">$ git pull</pre>
<p>This command will fetch changes from the remote branches to your
remote-tracking branches <code class="literal">origin/*</code>, and merge the default branch into
the current branch.</p>
<p>More generally, a branch that is created from a remote-tracking branch
will pull
...
<a class="ulink" href="git-checkout.html" target="_top">git-checkout(1)</a>, to learn how to control these defaults.</p>
<p>In addition to saving you keystrokes, <code class="literal">git pull</code> also helps you by
producing a default commit message documenting the branch and
repository that you pulled from.</p>
<p>(But note that no such commit will be created in the case of a
<a class="link" href="#fast-forwards" title="Fast-forward merges">fast-forward</a>; instead, your branch will just be
updated to point to the latest commit from the upstream branch.)</p>
<p>The <code class="literal">git pull</code> command can also be given <code class="literal">.</code> as the "remote" repository,
in which case it just merges in a branch from the current repository; so
the commands</p>
<pre class="screen">$ git pull . branch
$ git merge branch</pre>
<p>are roughly equivalent.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="submitting-patches"></a>Submitting patches to a project</h2></div></div></div>

<p>If you just have a few changes, the simplest way to submit them may
just be to send them as patches in email:</p>
<p>First, use <a class="ulink" href="git-format-patch.html" target="_top">git-format-patch(1)</a>; for example:</p>
<pre class="screen">$ git format-patch origin</pre>
<p>will produce a numbered series of files in the current directory, one
for each patch in the current branch but not in <code class="literal">origin/HEAD</code>.</p>
<p><code class="literal">git format-patch</code> can include an initial "cover letter". You can insert
...
manner.</p>
<p>You can then import these into your mail client and send them by
...
their requirements for submitting patches.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="importing-patches"></a>Importing patches to a project</h2></div></div></div>

<p>Git also provides a tool called <a class="ulink" href="git-am.html" target="_top">git-am(1)</a> (am stands for
"apply mailbox"), for importing such an emailed series of patches.
Just save all of the patch-containing messages, in order, into a
single mailbox file, say <code class="literal">patches.mbox</code>, then run</p>
<pre class="screen">$ git am -3 patches.mbox</pre>
<p>Git will apply each patch in order; if any conflicts are found, it
...
leave your tree and index untouched, you may omit that option.)</p>
<p>Once the index is updated with the results of the conflict
resolution, instead of creating a new commit, just run</p>
<pre class="screen">$ git am --continue</pre>
<p>and Git will create the commit for you and continue applying the
remaining patches from the mailbox.</p>
<p>The final result will be a series of commits, one for each patch in
the original mailbox, with authorship and commit log message each
taken from the message containing each patch.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="public-repositories"></a>Public Git repositories</h2></div></div></div>
...
<pre class="screen">$ git clone /path/to/repository
$ git pull /path/to/other/repository</pre>
<p>or an ssh URL:</p>
<pre class="screen">$ git clone ssh://yourhost/~you/repository</pre>
...
like this:</p>
<pre class="literallayout">                      you push
your personal repo ------------------&gt; your public repo
      ...
      |                                     |
      |               they push             V
their public repo &lt;------------------- their repo</pre>
<p>We explain how to do this in the following sections.</p>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="setting-up-a-public-repository"></a>Setting up a public repository</h3></div></div></div>

<p>Assume your personal repository is in the directory <code class="literal">~/proj</code>.  We
first create a new clone of the repository and tell <code class="literal">git daemon</code> that it
is meant to be public:</p>
<pre class="screen">$ git clone --bare ~/proj proj.git
$ touch proj.git/git-daemon-export-ok</pre>
...
around it.</p>
<p>Next, copy <code class="literal">proj.git</code> to the server where you plan to host the
public repository.  You can use scp, rsync, or whatever is most
convenient.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="exporting-via-git"></a>Exporting a Git repository via the Git protocol</h3></div></div></div>
...
repository</a>", below.</p>
<p>Otherwise, all you need to do is start <a class="ulink" href="git-daemon.html" target="_top">git-daemon(1)</a>; it will
...
<p>You can also run <code class="literal">git daemon</code> as an inetd service; see the
<a class="ulink" href="git-daemon.html" target="_top">git-daemon(1)</a> man page for details.  (See especially the
examples section.)</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="exporting-via-http"></a>Exporting a git repository via HTTP</h3></div></div></div>
...
<pre class="screen">$ mv proj.git /home/you/public_html/proj.git
$ cd proj.git
$ git --bare update-server-info
$ mv hooks/post-update.sample hooks/post-update</pre>
<p>(For an explanation of the last two lines, see
<a class="ulink" href="git-update-server-info.html" target="_top">git-update-server-info(1)</a> and <a class="ulink" href="githooks.html" target="_top">githooks(5)</a>.)</p>
<p>Advertise the URL of <code class="literal">proj.git</code>.  Anybody else should then be able to
clone or pull from that URL, for example with a command line like:</p>
<pre class="screen">$ git clone http://yourserver.com/~you/proj.git</pre>
<p>(See also
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="pushing-changes-to-a-public-repository"></a>Pushing changes to a public repository</h3></div></div></div>

<p>Note that the two techniques outlined above (exporting via
...
<p>The simplest way to do this is using <a class="ulink" href="git-push.html" target="_top">git-push(1)</a> and ssh; to
update the remote branch named <code class="literal">master</code> with the latest state of your
branch named <code class="literal">master</code>, run</p>
<pre class="screen">$ git push ssh://yourserver.com/~you/proj.git master:master</pre>
<p>or just</p>
<pre class="screen">$ git push ssh://yourserver.com/~you/proj.git master</pre>
<p>As with <code class="literal">git fetch</code>, <code class="literal">git push</code> will complain if this does not result in a
...
<p>Note that the target of a <code class="literal">push</code> is normally a
...
in <a class="ulink" href="git-config.html" target="_top">git-config(1)</a> for details.</p>
<p>As with <code class="literal">git fetch</code>, you may also set up configuration options to
save typing; so, for example:</p>
<pre class="screen">$ git remote add public-repo ssh://yourserver.com/~you/proj.git</pre>
<p>adds the following to <code class="literal">.git/config</code>:</p>
<pre class="screen">[remote "public-repo"]
        url = yourserver.com:proj.git
        fetch = +refs/heads/*:refs/remotes/example/*</pre>
<p>which lets you do the same push with just</p>
<pre class="screen">$ git push public-repo master</pre>
<p>See the explanations of the <code class="literal">remote.&lt;name&gt;.url</code>,
<code class="literal">branch.&lt;name&gt;.remote</code>, and <code class="literal">remote.&lt;name&gt;.push</code> options in
<a class="ulink" href="git-config.html" target="_top">git-config(1)</a> for details.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="forcing-push"></a>What to do when a push fails</h3></div></div></div>

<p>If a push would not result in a <a class="link" href="#fast-forwards" title="Fast-forward merges">fast-forward</a> of the
remote branch, then it will fail with an error like:</p>
<pre class="screen"> ! [rejected]        master -&gt; master (non-fast-forward)
...
<p>You may force <code class="literal">git push</code> to perform the update anyway by preceding the
branch name with a plus sign:</p>
<pre class="screen">$ git push ssh://yourserver.com/~you/proj.git +master</pre>
<p>Note the addition of the <code class="literal">+</code> sign.  Alternatively, you can use the
<code class="literal">-f</code> flag to force the remote update, as in:</p>
<pre class="screen">$ git push -f ssh://yourserver.com/~you/proj.git master</pre>
<p>Normally whenever a branch head in a public repository is modified, it
is modified to point to a descendant of the commit that it pointed to
before.  By forcing a push in this situation, you break that convention.
(See <a class="xref" href="#problems-With-rewriting-history" title="Problems with rewriting history">the section called “Problems with rewriting history”</a>.)</p>
...
<a class="ulink" href="gitcvs-migration.html" target="_top">gitcvs-migration(7)</a> for more.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="setting-up-a-shared-repository"></a>Setting up a shared repository</h3></div></div></div>

<p>Another way to collaborate is by using a model similar to that
...
set this up.</p>
<p>However, while there is nothing wrong with Git’s support for shared
repositories, this mode of operation is not generally recommended,
simply because the mode of collaboration that Git supports—​by
exchanging patches and pulling from public repositories—​has so many
advantages over the central shared repository:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="setting-up-gitweb"></a>Allowing web browsing of a repository</h3></div></div></div>

<p>The gitweb cgi script provides users an easy way to browse your
project’s revisions, file contents and logs without having to install
Git. Features like RSS/Atom feeds and blame/annotation details may
optionally be enabled.</p>
<p>The <a class="ulink" href="git-instaweb.html" target="_top">git-instaweb(1)</a> command provides a simple way to start
browsing the repository using gitweb. The default server when using
instaweb is lighttpd.</p>
<p>See the file gitweb/INSTALL in the Git source tree and
<a class="ulink" href="gitweb.html" target="_top">gitweb(1)</a> for instructions on details setting up a permanent
installation with a CGI or Perl capable server.</p>
</div>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="how-to-get-a-git-repository-with-minimal-history"></a>How to get a Git repository with minimal history</h2></div></div></div>

<p>A <a class="link" href="#def_shallow_clone">shallow clone</a>, with its truncated
history, is useful when one is interested only in recent history
of a project and getting full history from the upstream is
expensive.</p>
<p>A <a class="link" href="#def_shallow_clone">shallow clone</a> is created by specifying
...
history restored with <code class="literal">--unshallow</code>.</p>
<p>Merging inside a <a class="link" href="#def_shallow_clone">shallow clone</a> will work as long
...
a repository unsuitable to be used in merge based workflows.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="sharing-development-examples"></a>Examples</h2></div></div></div>

<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="maintaining-topic-branches"></a>Maintaining topic branches for a Linux subsystem maintainer</h3></div></div></div>

<p>This describes how Tony Luck uses Git in his role as maintainer of the
IA64 architecture for the Linux kernel.</p>
<p>He uses two public branches:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<p>He also uses a set of temporary branches ("topic branches"), each
containing a logical grouping of patches.</p>
<p>To set this up, first create your work tree by cloning Linus’s public
tree:</p>
<pre class="screen">$ git clone git://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git work
$ cd work</pre>
<p>Linus’s tree will be stored in the remote-tracking branch named origin/master,
...
<a class="xref" href="#repositories-and-branches" title="Chapter 1. Repositories and Branches">Chapter 1, <i>Repositories and Branches</i></a>.</p>
...
Linus by default.</p>
<pre class="screen">$ git branch --track test origin/master
$ git branch --track release origin/master</pre>
<p>These can be easily kept up to date using <a class="ulink" href="git-pull.html" target="_top">git-pull(1)</a>.</p>
<pre class="screen">$ git switch test &amp;&amp; git pull
$ git switch release &amp;&amp; git pull</pre>
<p>Important note!  If you have any local changes in these branches, then
...
from the release branch.</p>
<p>A few configuration variables (see <a class="ulink" href="git-config.html" target="_top">git-config(1)</a>) can
make it easy to push both branches to your public tree.  (See
<a class="xref" href="#setting-up-a-public-repository" title="Setting up a public repository">the section called “Setting up a public repository”</a>.)</p>
<pre class="screen">$ cat &gt;&gt; .git/config &lt;&lt;EOF
[remote "mytree"]
        url =  master.kernel.org:/pub/scm/linux/kernel/git/aegl/linux.git
        push = release
        push = test
EOF</pre>
<p>Then you can push both the test and release trees using
<a class="ulink" href="git-push.html" target="_top">git-push(1)</a>:</p>
<pre class="screen">$ git push mytree</pre>
<p>or push just one of the test and release branches using:</p>
<pre class="screen">$ git push mytree test</pre>
<p>or</p>
<pre class="screen">$ git push mytree release</pre>
<p>Now to apply some patches from the community.  Think of a short
snappy name for a branch to hold this patch (or related group of
patches), and create a new branch from a recent stable tag of
Linus’s branch. Picking a stable base for your branch will:
1) help you: by avoiding inclusion of unrelated and perhaps lightly
tested changes
2) help future bug hunters that use <code class="literal">git bisect</code> to find problems</p>
<pre class="screen">$ git switch -c speed-up-spinlocks v2.6.35</pre>
<p>Now you apply the patch(es), run some tests, and commit the change(s).  If
the patch is a multi-part series, then you should apply each as a separate
commit to this branch.</p>
<pre class="screen">$ ... patch ... test  ... commit [ ... patch ... test ... commit ]*</pre>
<p>When you are happy with the state of this change, you can merge it into the
"test" branch in preparation to make it public:</p>
<pre class="screen">$ git switch test &amp;&amp; git merge speed-up-spinlocks</pre>
<p>It is unlikely that you would have any conflicts here …​ but you might if you
spent a while on this step and had also pulled new versions from upstream.</p>
<p>Sometime later when enough time has passed and testing done, you can pull the
same branch into the <code class="literal">release</code> tree ready to go upstream.  This is where you
see the value of keeping each patch (or patch series) in its own branch.  It
means that the patches can be moved into the <code class="literal">release</code> tree in any order.</p>
<pre class="screen">$ git switch release &amp;&amp; git merge speed-up-spinlocks</pre>
<p>After a while, you will have a number of branches, and despite the
well chosen names you picked for each of them, you may forget what
they are for, or what status they are in.  To get a reminder of what
changes are in a specific branch, use:</p>
<pre class="screen">$ git log linux..branchname | git shortlog</pre>
<p>To see whether it has already been merged into the test or release branches,
use:</p>
<pre class="screen">$ git log test..branchname</pre>
<p>or</p>
<pre class="screen">$ git log release..branchname</pre>
<p>(If this branch has not yet been merged, you will see some log entries.
If it has been merged, then there will be no output.)</p>
<p>Once a patch completes the great cycle (moving from test to release,
then pulled by Linus, and finally coming back into your local
<code class="literal">origin/master</code> branch), the branch for this change is no longer needed.
You detect this when the output from:</p>
<pre class="screen">$ git log origin..branchname</pre>
<p>is empty.  At this point the branch can be deleted:</p>
<pre class="screen">$ git branch -d branchname</pre>
<p>Some changes are so trivial that it is not necessary to create a separate
branch and then merge into each of the test and release branches.  For
these changes, just apply directly to the <code class="literal">release</code> branch, and then
merge that into the <code class="literal">test</code> branch.</p>
<p>After pushing your work to <code class="literal">mytree</code>, you can use
<a class="ulink" href="git-request-pull.html" target="_top">git-request-pull(1)</a> to prepare a "please pull" request message
to send to Linus:</p>
<pre class="screen">$ git push mytree
$ git request-pull origin mytree release</pre>
<p>Here are some of the scripts that simplify all this even further.</p>
<pre class="screen">==== update script ====
...
<pre class="screen">==== status script ====
...
cause Git’s merge machinery (for example) to do the wrong thing.</p>
<p>However, there is a situation in which it can be useful to violate this
assumption.</p>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="patch-series"></a>Creating the perfect patch series</h2></div></div></div>

<p>Suppose you are a contributor to a large project, and you want to add a
complicated feature, and to present it to the other developers in a way
that makes it easy for them to read your changes, verify that they are
correct, and understand why you made each change.</p>
<p>If you present all of your changes as a single patch (or commit), they
may find that it is too much to digest all at once.</p>
<p>If you present them with the entire history of your work, complete with
mistakes, corrections, and dead ends, they may be overwhelmed.</p>
<p>So the ideal is usually to produce a series of patches such that:</p>
<div class="orderedlist"><ol class="orderedlist" type="1"><li class="listitem">
...
<p>We will introduce some tools that can help you do this, explain how to
use them, and then explain some of the problems that can arise because
you are rewriting history.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="using-git-rebase"></a>Keeping a patch series up to date using git rebase</h2></div></div></div>

<p>Suppose that you create a branch <code class="literal">mywork</code> on a remote-tracking branch
<code class="literal">origin</code>, and create some commits on top of it:</p>
<pre class="screen">$ git switch -c mywork origin
$ vi file.txt
$ git commit
$ vi otherfile.txt
$ git commit
...</pre>
<p>You have performed no merges into mywork, so it is just a simple linear
sequence of patches on top of <code class="literal">origin</code>:</p>
<pre class="literallayout"> o--o--O &lt;-- origin
        \
         a--b--c &lt;-- mywork</pre>
<p>Some more interesting work has been done in the upstream project, and
<code class="literal">origin</code> has advanced:</p>
<pre class="literallayout"> o--o--O--o--o--o &lt;-- origin
        \
         a--b--c &lt;-- mywork</pre>
<p>At this point, you could use <code class="literal">pull</code> to merge your changes back in;
...
<a class="ulink" href="git-rebase.html" target="_top">git-rebase(1)</a>:</p>
<pre class="screen">$ git switch mywork
...
patches to the new mywork.  The result will look like:</p>
<pre class="literallayout"> o--o--O--o--o--o &lt;-- origin
                 \
                  a'--b'--c' &lt;-- mywork</pre>
<p>In the process, it may discover conflicts.  In that case it will stop
and allow you to fix the conflicts; after fixing conflicts, use <code class="literal">git add</code>
to update the index with those contents, and then, instead of
running <code class="literal">git commit</code>, just run</p>
<pre class="screen">$ git rebase --continue</pre>
<p>and Git will continue applying the rest of the patches.</p>
<p>At any point you may use the <code class="literal">--abort</code> option to abort this process and
return mywork to the state it had before you started the rebase:</p>
<pre class="screen">$ git rebase --abort</pre>
<p>If you need to reorder or edit a number of commits in a branch, it may
...
<a class="xref" href="#reordering-patch-series" title="Reordering or selecting from a patch series">the section called “Reordering or selecting from a patch series”</a> for alternatives.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="rewriting-one-commit"></a>Rewriting a single commit</h2></div></div></div>

<p>We saw in <a class="xref" href="#fixing-a-mistake-by-rewriting-history" title="Fixing a mistake by rewriting history">the section called “Fixing a mistake by rewriting history”</a> that you can replace the
most recent commit using</p>
<pre class="screen">$ git commit --amend</pre>
<p>which will replace the old commit by a new commit incorporating your
changes, giving you a chance to edit the old commit message first.
This is useful for fixing typos in your last commit, or for adjusting
the patch contents of a poorly staged commit.</p>
<p>If you need to amend commits from deeper in your history, you can
use <a class="link" href="#interactive-rebase" title="Using interactive rebases">interactive rebase’s <code class="literal">edit</code> instruction</a>.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="reordering-patch-series"></a>Reordering or selecting from a patch series</h2></div></div></div>

<p>Sometimes you want to edit a commit deeper in your history.  One
approach is to use <code class="literal">git format-patch</code> to create a series of patches
and then reset the state to before the patches:</p>
<pre class="screen">$ git format-patch origin
$ git reset --hard origin</pre>
<p>Then modify, reorder, or eliminate patches as needed before applying
them again with <a class="ulink" href="git-am.html" target="_top">git-am(1)</a>:</p>
<pre class="screen">$ git am *.patch</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="interactive-rebase"></a>Using interactive rebases</h2></div></div></div>

<p>You can also edit a patch series with an interactive rebase.  This is
the same as <a class="link" href="#reordering-patch-series" title="Reordering or selecting from a patch series">reordering a patch series using
<code class="literal">format-patch</code></a>, so use whichever interface you like best.</p>
<p>Rebase your current HEAD on the last commit you want to retain as-is.
For example, if you want to reorder the last 5 commits, use:</p>
<pre class="screen">$ git rebase -i HEAD~5</pre>
<p>This will open your editor with a list of steps to be taken to perform
your rebase.</p>
<pre class="screen">pick deadbee The oneline of this commit
...
<p>As explained in the comments, you can reorder commits, squash them
...
will begin.</p>
<p>The rebase will stop where <code class="literal">pick</code> has been replaced with <code class="literal">edit</code> or
...
the original branch by using the <a class="link" href="#reflogs" title="Reflogs">reflog</a>.</p>
<p>For a more detailed discussion of the procedure and additional tips,
see the "INTERACTIVE MODE" section of <a class="ulink" href="git-rebase.html" target="_top">git-rebase(1)</a>.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="patch-series-tools"></a>Other tools</h2></div></div></div>

<p>There are numerous other tools, such as StGit, which exist for the
purpose of maintaining a patch series.  These are outside of the scope of
this manual.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="problems-With-rewriting-history"></a>Problems with rewriting history</h2></div></div></div>

<p>The primary problem with rewriting the history of a branch has to do
with merging.  Suppose somebody fetches your branch and merges it into
their branch, with a result something like this:</p>
<pre class="literallayout"> o--o--O--o--o--o &lt;-- origin
        \        \
         t--t--t--m &lt;-- their branch:</pre>
<p>Then suppose you modify the last three commits:</p>
<pre class="literallayout">         o--o--o &lt;-- new head of origin
        /
 o--o--O--o--o--o &lt;-- old head of origin</pre>
<p>If we examined all this history together in one repository, it will
look like:</p>
<pre class="literallayout">         o--o--o &lt;-- new head of origin
        /
 o--o--O--o--o--o &lt;-- old head of origin
        \        \
         t--t--t--m &lt;-- their branch:</pre>
<p>Git has no way of knowing that the new head is an updated version of
the old head; it treats this situation exactly the same as it would if
two developers had independently done the work on the old and new heads
in parallel.  At this point, if someone attempts to merge the new head
in to their branch, Git will attempt to merge together the two (old and
new) lines of development, instead of trying to replace the old by the
new.  The results are likely to be unexpected.</p>
<p>You may still choose to publish branches whose history is rewritten,
and it may be useful for others to be able to fetch those branches in
order to examine or test them, but they should not attempt to pull such
branches into their own work.</p>
<p>For true distributed development that supports proper merging,
published branches should never be rewritten.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="bisect-merges"></a>Why bisecting merge commits can be harder than bisecting linear history</h2></div></div></div>

<p>The <a class="ulink" href="git-bisect.html" target="_top">git-bisect(1)</a> command correctly handles history that
includes merge commits.  However, when the commit that it finds is a
merge commit, the user may need to work harder than usual to figure out
why that commit introduced a problem.</p>
<p>Imagine this history:</p>
<pre class="literallayout">      ---Z---o---X---...---o---A---C---D
          \                       /
           o---o---Y---...---o---B</pre>
<p>Suppose that on the upper line of development, the meaning of one
...
bug at A.</p>
<p>Suppose that in the meantime on the lower line of development somebody
adds a new calling site for that function at commit Y.  The
commits from Z leading to B all assume the old semantics of that
function and the callers and the callee are consistent with each
other.  There is no bug at B, either.</p>
<p>Suppose further that the two development lines merge cleanly at C,
so no conflict resolution is required.</p>
<p>Nevertheless, the code at C is broken, because the callers added
...
figure out that the problem is due to this change in semantics?</p>
<p>When the result of a <code class="literal">git bisect</code> is a non-merge commit, you should
...
<p>On the other hand, if instead of merging at C you had rebased the
history between Z to B on top of A, you would have gotten this
linear history:</p>
<pre class="literallayout">    ---Z---o---X--...---o---A---o---o---Y*--...---o---B*--D*</pre>
<p>Bisecting between Z and D* would hit a single culprit commit Y*,
and understanding why Y* was broken would probably be easier.</p>
<p>Partly for this reason, many experienced Git users, even when
...
<p>Instead of using <a class="ulink" href="git-remote.html" target="_top">git-remote(1)</a>, you can also choose just
to update one branch at a time, and to store it locally under an
arbitrary name:</p>
<pre class="screen">$ git fetch origin todo:my-todo-work</pre>
<p>The first argument, <code class="literal">origin</code>, just tells Git to fetch from the
repository you originally cloned from.  The second argument tells Git
to fetch the branch named <code class="literal">todo</code> from the remote repository, and to
store it locally under the name <code class="literal">refs/heads/my-todo-work</code>.</p>
<p>You can also fetch branches from other repositories; so</p>
<pre class="screen">$ git fetch git://example.com/proj.git master:example-master</pre>
<p>will create a new branch named <code class="literal">example-master</code> and store in it the
...
master branch.  In more detail:</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="fetch-fast-forwards"></a>git fetch and fast-forwards</h2></div></div></div>

<p>In the previous example, when updating an existing branch, <code class="literal">git fetch</code>
checks to make sure that the most recent commit on the remote
branch is a descendant of the most recent commit on your copy of the
branch before updating your copy of the branch to point at the new
commit.  Git calls this process a <a class="link" href="#fast-forwards" title="Fast-forward merges">fast-forward</a>.</p>
<p>A fast-forward looks something like this:</p>
<pre class="literallayout"> o--o--o--o &lt;-- old head of the branch
           \
            o--o--o &lt;-- new head of the branch</pre>
<p>In some cases it is possible that the new head will <span class="strong"><strong>not</strong></span> actually be
a descendant of the old head.  For example, the developer may have
realized she made a serious mistake, and decided to backtrack,
resulting in a situation like:</p>
<pre class="literallayout"> o--o--o--o--a--b &lt;-- old head of the branch
           \
            o--o--o &lt;-- new head of the branch</pre>
<p>In this case, <code class="literal">git fetch</code> will fail, and print out a warning.</p>
<p>In that case, you can still force Git to update to the new head, as
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="forcing-fetch"></a>Forcing git fetch to do non-fast-forward updates</h2></div></div></div>

<p>If git fetch fails because the new head of a branch is not a
descendant of the old head, you may force the update with:</p>
<pre class="screen">$ git fetch git://example.com/proj.git +master:refs/remotes/example/master</pre>
<p>Note the addition of the <code class="literal">+</code> sign.  Alternatively, you can use the <code class="literal">-f</code>
flag to force updates of all the fetched branches, as in:</p>
<pre class="screen">$ git fetch -f origin</pre>
<p>Be aware that commits that the old version of example/master pointed at
may be lost, as we saw in the previous section.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="remote-branch-configuration"></a>Configuring remote-tracking branches</h2></div></div></div>

<p>We saw above that <code class="literal">origin</code> is just a shortcut to refer to the
repository that you originally cloned from.  This information is
stored in Git configuration variables, which you can see using
<a class="ulink" href="git-config.html" target="_top">git-config(1)</a>:</p>
<pre class="screen">$ git config -l
...
<p>If there are other repositories that you also use frequently, you can
create similar configuration options to save typing; for example,</p>
<pre class="screen">$ git remote add example git://example.com/proj.git</pre>
<p>adds the following to <code class="literal">.git/config</code>:</p>
<pre class="screen">[remote "example"]
        url = git://example.com/proj.git
        fetch = +refs/heads/*:refs/remotes/example/*</pre>
<p>Also note that the above configuration can be performed by directly
editing the file <code class="literal">.git/config</code> instead of using <a class="ulink" href="git-remote.html" target="_top">git-remote(1)</a>.</p>
<p>After configuring the remote, the following three commands will do the
same thing:</p>
<pre class="screen">$ git fetch git://example.com/proj.git +refs/heads/*:refs/remotes/example/*
$ git fetch example +refs/heads/*:refs/remotes/example/*
$ git fetch example</pre>
<p>See <a class="ulink" href="git-config.html" target="_top">git-config(1)</a> for more details on the configuration
...
Git much more intuitive if you do.</p>
<p>We start with the most important, the  <a class="link" href="#def_object_database">object
database</a> and the <a class="link" href="#def_index">index</a>.</p>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="the-object-database"></a>The Object Database</h2></div></div></div>

<p>We already saw in <a class="xref" href="#understanding-commits" title="Understanding History: Commits">the section called “Understanding History: Commits”</a> that all commits are stored
...
<p>(See <a class="xref" href="#object-details" title="Object storage format">the section called “Object storage format”</a> for the details of the object formatting and
SHA-1 calculation.)</p>
<p>There are four different types of objects: "blob", "tree", "commit", and
"tag".</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="commit-object"></a>Commit Object</h3></div></div></div>

<p>The "commit" object links a physical state of a tree with a description
...
commit:</p>
<pre class="screen">$ git show -s --pretty=raw 2be7fcb476
...
<p>As you can see, a commit is defined by:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<p>Note that a commit does not itself contain any information about what
actually changed; all changes are calculated by comparing the contents
of the tree referred to by this commit with the trees associated with
its parents.  In particular, Git does not attempt to record file renames
explicitly, though it can identify cases where the existence of the same
file data at changing paths suggests a rename.  (See, for example, the
<code class="literal">-M</code> option to <a class="ulink" href="git-diff.html" target="_top">git-diff(1)</a>).</p>
<p>A commit is usually created by <a class="ulink" href="git-commit.html" target="_top">git-commit(1)</a>, which creates a
commit whose parent is normally the current HEAD, and whose tree is
taken from the content currently stored in the index.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="tree-object"></a>Tree Object</h3></div></div></div>

<p>The ever-versatile <a class="ulink" href="git-show.html" target="_top">git-show(1)</a> command can also be used to
examine tree objects, but <a class="ulink" href="git-ls-tree.html" target="_top">git-ls-tree(1)</a> will give you more
details:</p>
<pre class="screen">$ git ls-tree fb3a8bdd0ce
...
...</pre>
<p>As you can see, a tree object contains a list of entries, each with a
mode, object type, SHA-1 name, and name, sorted by name.  It represents
the contents of a single directory tree.</p>
<p>The object type may be a blob, representing the contents of a file, or
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="blob-object"></a>Blob Object</h3></div></div></div>

<p>You can use <a class="ulink" href="git-show.html" target="_top">git-show(1)</a> to examine the contents of a blob; take,
for example, the blob in the entry for <code class="literal">COPYING</code> from the tree above:</p>
<pre class="screen">$ git show 6ff87c4664

 Note that the only valid version of the GPL as far as this project
 is concerned is _this_ particular version of the license (ie v2, not
 v2.2 or v3.x or whatever), unless explicitly otherwise stated.
...</pre>
<p>A "blob" object is nothing but a binary blob of data.  It doesn’t refer
to anything else or have attributes of any kind.</p>
<p>Since the blob is entirely defined by its data, if two files in a
directory tree (or in multiple different versions of the repository)
have the same contents, they will share the same blob object. The object
is totally independent of its location in the directory tree, and
renaming a file does not change the object that file is associated with.</p>
<p>Note that any tree or blob object can be examined using
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="trust"></a>Trust</h3></div></div></div>

<p>If you receive the SHA-1 name of a blob from one source, and its contents
from another (possibly untrusted) source, you can still trust that those
contents are correct as long as the SHA-1 name agrees.  This is because
the SHA-1 is designed so that it is infeasible to find different contents
that produce the same hash.</p>
<p>Similarly, you need only trust the SHA-1 name of a top-level tree object
to trust the contents of the entire directory that it refers to, and if
you receive the SHA-1 name of a commit from a trusted source, then you
can easily verify the entire history of commits reachable through
parents of that commit, and all of those contents of the trees referred
to by those commits.</p>
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="tag-object"></a>Tag Object</h3></div></div></div>

<p>A tag object contains an object, object type, tag name, the name of the
person ("tagger") who created the tag, and a message, which may contain
a signature, as can be seen using <a class="ulink" href="git-cat-file.html" target="_top">git-cat-file(1)</a>:</p>
<pre class="screen">$ git cat-file tag v1.5.0
...
<p>See the <a class="ulink" href="git-tag.html" target="_top">git-tag(1)</a> command to learn how to create and verify tag
objects.  (Note that <a class="ulink" href="git-tag.html" target="_top">git-tag(1)</a> can also be used to create
"lightweight tags", which are not tag objects at all, but just simple
references whose names begin with <code class="literal">refs/tags/</code>).</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="pack-files"></a>How Git stores objects efficiently: pack files</h3></div></div></div>

<p>Newly created objects are initially created in a file named after the
object’s SHA-1 hash (stored in <code class="literal">.git/objects</code>).</p>
<p>Unfortunately this system becomes inefficient once a project has a
lot of objects.  Try this on an old project:</p>
<pre class="screen">$ git count-objects
6930 objects, 47620 kilobytes</pre>
<p>The first number is the number of objects which are kept in
individual files.  The second is the amount of space taken up by
those "loose" objects.</p>
<p>You can save space and make Git faster by moving these loose objects in
to a "pack file", which stores a group of objects in an efficient
compressed format; the details of how pack files are formatted can be
found in <a class="ulink" href="technical/pack-format.html" target="_top">pack format</a>.</p>
<p>To put the loose objects into a pack, just run git repack:</p>
<pre class="screen">$ git repack
Counting objects: 6020, done.
Delta compression using up to 4 threads.
Compressing objects: 100% (6020/6020), done.
Writing objects: 100% (6020/6020), done.
Total 6020 (delta 4070), reused 0 (delta 0)</pre>
<p>This creates a single "pack file" in .git/objects/pack/
containing all currently unpacked objects.  You can then run</p>
<pre class="screen">$ git prune</pre>
<p>to remove any of the "loose" objects that are now contained in the
pack.  This will also remove any unreferenced objects (which may be
created when, for example, you use <code class="literal">git reset</code> to remove a commit).
You can verify that the loose objects are gone by looking at the
<code class="literal">.git/objects</code> directory or by running</p>
<pre class="screen">$ git count-objects
0 objects, 0 kilobytes</pre>
<p>Although the object files are gone, any commands that refer to those
objects will work exactly as they did before.</p>
<p>The <a class="ulink" href="git-gc.html" target="_top">git-gc(1)</a> command performs packing, pruning, and more for
you, so is normally the only high-level command you need.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="dangling-objects"></a>Dangling objects</h3></div></div></div>

<p>The <a class="ulink" href="git-fsck.html" target="_top">git-fsck(1)</a> command will sometimes complain about dangling
...
object.</p>
<p>Similarly, when the "recursive" merge strategy runs, and finds that
there are criss-cross merges and thus more than one merge base (which is
fairly unusual, but it does happen), it will generate one temporary
midway tree (or possibly even more, if you had lots of criss-crossing
merges and more than two merge bases) as a temporary internal merge
base, and again, those are real objects, but the end result will not end
up pointing to them, so they end up "dangling" in your repository.</p>
<p>Generally, dangling objects aren’t anything to worry about. They can
even be very useful: if you screw something up, the dangling objects can
be how you recover your old tree (say, you did a rebase, and realized
that you really didn’t want to—​you can look at what dangling objects
you have, and decide to reset your head to some old dangling state).</p>
<p>For commits, you can just use:</p>
<pre class="screen">$ gitk &lt;dangling-commit-sha-goes-here&gt; --not --all</pre>
<p>This asks for all the history reachable from the given commit but not
from any branch, tag, or other reference.  If you decide it’s something
you want, you can always create a new reference to it, e.g.,</p>
<pre class="screen">$ git branch recovered-branch &lt;dangling-commit-sha-goes-here&gt;</pre>
<p>For blobs and trees, you can’t do the same, but you can still examine
them.  You can just do</p>
<pre class="screen">$ git show &lt;dangling-blob/tree-sha-goes-here&gt;</pre>
<p>to show what the contents of the blob were (or, for a tree, basically
what the <code class="literal">ls</code> for that directory was), and that may give you some idea
of what the operation was that left that dangling object.</p>
<p>Usually, dangling blobs and trees aren’t very interesting. They’re
...
dangling and useless.</p>
<p>Anyway, once you are sure that you’re not interested in any dangling
state, you can just prune all unreachable objects:</p>
<pre class="screen">$ git prune</pre>
<p>and they’ll be gone. (You should only run <code class="literal">git prune</code> on a quiescent
repository—​it’s kind of like doing a filesystem fsck recovery: you
don’t want to do that while the filesystem is mounted.
<code class="literal">git prune</code> is designed not to cause any harm in such cases of concurrent
accesses to a repository but you might receive confusing or scary messages.)</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="recovering-from-repository-corruption"></a>Recovering from repository corruption</h3></div></div></div>

<p>By design, Git treats data trusted to it with caution.  However, even in
the absence of bugs in Git itself, it is still possible that hardware or
operating system errors could corrupt data.</p>
<p>The first defense against such problems is backups.  You can back up a
Git directory using clone, or just using cp, tar, or any other backup
mechanism.</p>
<p>As a last resort, you can search for the corrupted objects and attempt
to replace them by hand.  Back up your repository before attempting this
in case you corrupt things even more in the process.</p>
<p>We’ll assume that the problem is a single missing or corrupted blob,
which is sometimes a solvable problem.  (Recovering missing trees and
especially commits is <span class="strong"><strong>much</strong></span> harder).</p>
<p>Before starting, verify that there is corruption, and figure out where
it is with <a class="ulink" href="git-fsck.html" target="_top">git-fsck(1)</a>; this may be time-consuming.</p>
<p>Assume the output looks like this:</p>
<pre class="screen">$ git fsck --full --no-dangling
broken link from    tree 2d9263c6d23595e7cb2a21e5ebbb53655278dff8
              to    blob 4b9458b3786228369c63936db65827de3cc06200
missing blob 4b9458b3786228369c63936db65827de3cc06200</pre>
<p>Now you know that blob 4b9458b3 is missing, and that the tree 2d9263c6
...
which might output something like:</p>
<pre class="screen">$ git ls-tree 2d9263c6d23595e7cb2a21e5ebbb53655278dff8
...
...</pre>
<p>So now you know that the missing blob was the data for a file named
...
<a class="ulink" href="git-hash-object.html" target="_top">git-hash-object(1)</a>:</p>
<pre class="screen">$ git hash-object -w somedirectory/myfile</pre>
<p>which will create and store a blob object with the contents of
somedirectory/myfile, and output the SHA-1 of that object.  if you’re
extremely lucky it might be 4b9458b3786228369c63936db65827de3cc06200, in
which case you’ve guessed right, and the corruption is fixed!</p>
<p>Otherwise, you need more information.  How do you tell which version of
the file has been lost?</p>
<p>The easiest way to do this is with:</p>
<pre class="screen">$ git log --raw --all --full-history -- somedirectory/myfile</pre>
<p>Because you’re asking for raw output, you’ll now get something like</p>
<pre class="screen">commit abc
Author:
Date:
...
...
...
:100644 100644 oldsha 4b9458b M somedirectory/myfile</pre>
<p>This tells you that the immediately following version of the file was
"newsha", and that the immediately preceding version was "oldsha".
You also know the commit messages that went with the change from oldsha
to 4b9458b and with the change from 4b9458b to newsha.</p>
<p>If you’ve been committing small enough changes, you may now have a good
shot at reconstructing the contents of the in-between state 4b9458b.</p>
<p>If you can do that, you can now recreate the missing object with</p>
<pre class="screen">$ git hash-object -w &lt;recreated-file&gt;</pre>
<p>and your repository is good again!</p>
<p>(Btw, you could have ignored the <code class="literal">fsck</code>, and started with doing a</p>
<pre class="screen">$ git log --raw --all</pre>
<p>and just looked for the sha of the missing object (4b9458b) in that
whole thing. It’s up to you—​Git does <span class="strong"><strong>have</strong></span> a lot of information, it is
just missing one particular blob version.</p>
</div>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="the-index"></a>The index</h2></div></div></div>

<p>The index is a binary file (generally kept in <code class="literal">.git/index</code>) containing a
sorted list of path names, each with permissions and the SHA-1 of a blob
object; <a class="ulink" href="git-ls-files.html" target="_top">git-ls-files(1)</a> can show you the contents of the index:</p>
<pre class="screen">$ git ls-files --stage
...
100644 d5de8292e05e7c36c4b68857c1cf9855e3d2f70a 0       xdiff/xutils.h</pre>
<p>Note that in older documentation you may see the index called the
"current directory cache" or just the "cache".  It has three important
properties:</p>
<div class="orderedlist"><ol class="orderedlist" type="1"><li class="listitem">
<p class="simpara">The index contains all the information necessary to generate a single
(uniquely determined) tree object.</p>
<p class="simpara">For example, running <a class="ulink" href="git-commit.html" target="_top">git-commit(1)</a> generates this tree object
from the index, stores it in the object database, and uses it as the
tree object associated with the new commit.</p>
</li><li class="listitem">
<p class="simpara">The index enables fast comparisons between the tree object it defines
and the working tree.</p>
<p class="simpara">It does this by storing some additional data for each entry (such as
the last modified time).  This data is not displayed above, and is not
stored in the created tree object, but it can be used to determine
quickly which files in the working directory differ from what was
stored in the index, and thus save Git from having to read all of the
data from such files to look for changes.</p>
</li><li class="listitem">
<p class="simpara">It can efficiently represent information about merge conflicts
between different tree objects, allowing each pathname to be
associated with sufficient information about the trees involved that
you can create a three-way merge between them.</p>
<p class="simpara">We saw in <a class="xref" href="#conflict-resolution" title="Getting conflict-resolution help during a merge">the section called “Getting conflict-resolution help during a merge”</a> that during a merge the index can
...
<p>The <a class="ulink" href="git-submodule.html" target="_top">git-submodule(1)</a> command is available since Git 1.5.3.  Users
with Git 1.5.2 can look up the submodule commits in the repository and
manually check them out; earlier versions won’t recognize the submodules at
all.</p>
<p>To see how submodule support works, create four example
repositories that can be used later as a submodule:</p>
<pre class="screen">$ mkdir ~/git
$ cd ~/git
$ for i in a b c d
do
        mkdir $i
...
<p>Do not use local URLs here if you plan to publish your superproject!</p>
</div>
<p>See what files <code class="literal">git submodule</code> created:</p>
<pre class="screen">$ ls -a
.  ..  .git  .gitmodules  a  b  c  d</pre>
<p>The <code class="literal">git submodule add &lt;repo&gt; &lt;path&gt;</code> command does a couple of things:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<pre class="screen">$ git commit -m "Add submodules a, b, c and d."</pre>
<p>Now clone the superproject:</p>
<pre class="screen">$ cd ..
$ git clone super cloned
$ cd cloned</pre>
<p>The submodule directories are there, but they’re empty:</p>
<pre class="screen">$ ls -a a
.  ..
$ git submodule status
-d266b9873ad50488163457f025db7cdd9683d88b a
-e81d457da15309b4fef4249aba9b50187999670d b
-c1536a972b9affea0f16e0680ba87332dc059146 c
-d96249ff5d57de5de093e6baff9e0aafa5276a74 d</pre>
<div class="note" style="margin-left: 0.5in; margin-right: 0.5in;"><h3 class="title">Note</h3>
<p>The commit object names shown above would be different for you, but they
should match the HEAD commit object names of your repositories.  You can check
it by running <code class="literal">git ls-remote ../a</code>.</p>
</div>
<p>Pulling down the submodules is a two-step process. First run <code class="literal">git submodule
init</code> to add the submodule repository URLs to <code class="literal">.git/config</code>:</p>
<pre class="screen">$ git submodule init</pre>
<p>Now use <code class="literal">git submodule update</code> to clone the repositories and check out the
commits specified in the superproject:</p>
<pre class="screen">$ git submodule update
$ cd a
$ ls -a
.  ..  .git  a.txt</pre>
<p>One major difference between <code class="literal">git submodule update</code> and <code class="literal">git submodule add</code> is
...
new commit:</p>
<pre class="screen">$ git switch master</pre>
<p>or</p>
<pre class="screen">$ git switch -c fix-up</pre>
<p>then</p>
<pre class="screen">$ echo "adding a line again" &gt;&gt; a.txt
...
$ git push</pre>
<p>You have to run <code class="literal">git submodule update</code> after <code class="literal">git pull</code> if you want to update
submodules, too.</p>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="pitfalls-with-submodules"></a>Pitfalls with submodules</h2></div></div></div>
...
<pre class="screen">$ cd ~/git/super/a
...
Unable to checkout '261dfac35cb99d380eb966e102c1197139f7fa24' in submodule path 'a'</pre>
<p>In older Git versions it could be easily forgotten to commit new or modified
...
output or used with the <code class="literal">--submodule</code> option:</p>
<pre class="screen">$ git diff
...
$ git diff --submodule
Submodule sub 3f35670..3f35670-dirty:</pre>
<p>You also should not rewind branches in a submodule beyond commits that were
ever recorded in any superproject.</p>
<p>It’s not safe to run <code class="literal">git submodule update</code> if you’ve made and committed
changes within a submodule without checking out a branch first. They will be
silently overwritten:</p>
<pre class="screen">$ cat a.txt
module a
...
module a</pre>
<div class="note" style="margin-left: 0.5in; margin-right: 0.5in;"><h3 class="title">Note</h3>
<p>The changes are still visible in the submodule’s reflog.</p>
</div>
<p>If you have uncommitted changes in your submodule working tree, <code class="literal">git
...
<div class="chapter"><div class="titlepage"><div><div><h1 class="title"><a name="low-level-operations"></a>Chapter 9. Low-level Git operations</h1></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl class="toc"><dt><span class="section"><a href="#object-manipulation">Object access and manipulation</a></span></dt><dt><span class="section"><a href="#the-workflow">The Workflow</a></span></dt><dd><dl><dt><span class="section"><a href="#working-directory-to-index">working directory → index</a></span></dt><dt><span class="section"><a href="#index-to-object-database">index → object database</a></span></dt><dt><span class="section"><a href="#object-database-to-index">object database → index</a></span></dt><dt><span class="section"><a href="#index-to-working-directory">index → working directory</a></span></dt><dt><span class="section"><a href="#tying-it-all-together">Tying it all together</a></span></dt></dl></dd><dt><span class="section"><a href="#examining-the-data">Examining the data</a></span></dt><dt><span class="section"><a href="#merging-multiple-trees">Merging multiple trees</a></span></dt><dt><span class="section"><a href="#merging-multiple-trees-2">Merging multiple trees, continued</a></span></dt></dl></div>
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="object-manipulation"></a>Object access and manipulation</h2></div></div></div>

<p>The <a class="ulink" href="git-cat-file.html" target="_top">git-cat-file(1)</a> command can show the contents of any object,
though the higher-level <a class="ulink" href="git-show.html" target="_top">git-show(1)</a> is usually more useful.</p>
<p>The <a class="ulink" href="git-commit-tree.html" target="_top">git-commit-tree(1)</a> command allows constructing commits with
arbitrary parents and trees.</p>
<p>A tree can be created with <a class="ulink" href="git-write-tree.html" target="_top">git-write-tree(1)</a> and its data can be
accessed by <a class="ulink" href="git-ls-tree.html" target="_top">git-ls-tree(1)</a>.  Two trees can be compared with
<a class="ulink" href="git-diff-tree.html" target="_top">git-diff-tree(1)</a>.</p>
<p>A tag is created with <a class="ulink" href="git-mktag.html" target="_top">git-mktag(1)</a>, and the signature can be
verified by <a class="ulink" href="git-verify-tag.html" target="_top">git-verify-tag(1)</a>, though it is normally simpler to
use <a class="ulink" href="git-tag.html" target="_top">git-tag(1)</a> for both.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="the-workflow"></a>The Workflow</h2></div></div></div>

<p>High-level operations such as <a class="ulink" href="git-commit.html" target="_top">git-commit(1)</a> and
<a class="ulink" href="git-restore.html" target="_top">git-restore(1)</a> work by moving data
...
combinations:</p>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="working-directory-to-index"></a>working directory → index</h3></div></div></div>

<p>The <a class="ulink" href="git-update-index.html" target="_top">git-update-index(1)</a> command updates the index with
information from the working directory.  You generally update the
index information by just specifying the filename you want to update,
like so:</p>
<pre class="screen">$ git update-index filename</pre>
...
should use the <code class="literal">--remove</code> and <code class="literal">--add</code> flags respectively.</p>
<p>NOTE! A <code class="literal">--remove</code> flag does <span class="emphasis"><em>not</em></span> mean that subsequent filenames will
...
<p>As a special case, you can also do <code class="literal">git update-index --refresh</code>, which
...
<p>The previously introduced <a class="ulink" href="git-add.html" target="_top">git-add(1)</a> is just a wrapper for
<a class="ulink" href="git-update-index.html" target="_top">git-update-index(1)</a>.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="index-to-object-database"></a>index → object database</h3></div></div></div>

<p>You write your current index file to a "tree" object with the program</p>
<pre class="screen">$ git write-tree</pre>
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="object-database-to-index"></a>object database → index</h3></div></div></div>

<p>You read a "tree" file from the object database, and use that to
populate (and overwrite—​don’t do this if your index contains any
unsaved state that you might want to restore later!) your current
index.  Normal operation is just</p>
<pre class="screen">$ git read-tree &lt;SHA-1 of tree&gt;</pre>
...
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="index-to-working-directory"></a>index → working directory</h3></div></div></div>

<p>You update your working directory from the index by "checking out"
files. This is not a very common operation, since normally you’d just
keep your files updated, and rather than write to your working
directory, you’d tell the index files about the changes in your
working directory (i.e. <code class="literal">git update-index</code>).</p>
<p>However, if you decide to jump to a new version, or check out somebody
else’s version, or just restore a previous tree, you’d populate your
index file with read-tree, and then you need to check out the result
with</p>
<pre class="screen">$ git checkout-index filename</pre>
<p>or, if you want to check out all of the index, use <code class="literal">-a</code>.</p>
<p>NOTE! <code class="literal">git checkout-index</code> normally refuses to overwrite old files, so
...
<span class="emphasis"><em>force</em></span> the checkout.</p>
<p>Finally, there are a few odds and ends which are not purely moving
from one representation to the other:</p>
</div>
<div class="section"><div class="titlepage"><div><div><h3 class="title"><a name="tying-it-all-together"></a>Tying it all together</h3></div></div></div>

<p>To commit a tree you have instantiated with <code class="literal">git write-tree</code>, you’d
...
<pre class="screen">$ git commit-tree &lt;tree&gt; -p &lt;parent&gt; [(-p &lt;parent2&gt;)...]</pre>
...
<p><code class="literal">git commit-tree</code> will return the name of the object that represents
...
<p>Here is a picture that illustrates how various pieces fit together:</p>
<pre class="screen">                     commit-tree
                      commit obj
                       +----+
                       |    |
                       |    |
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="examining-the-data"></a>Examining the data</h2></div></div></div>
...
object:</p>
<pre class="screen">$ git cat-file -t &lt;objectname&gt;</pre>
...
<pre class="screen">$ git cat-file blob|tree|commit|tag &lt;objectname&gt;</pre>
...
you can do</p>
<pre class="screen">$ git cat-file commit HEAD</pre>
<p>to see what the top commit was.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="merging-multiple-trees"></a>Merging multiple trees</h2></div></div></div>

<p>Git can help you perform a three-way merge, which can in turn be
used for a many-way merge by repeating the merge procedure several
times.  The usual situation is that you only do one three-way merge
(reconciling two lines of history) and commit the result, but if
you like to, you can merge several branches in one go.</p>
<p>To perform a three-way merge, you start with the two commits you
want to merge, find their closest common parent (a third commit),
and compare the trees corresponding to these three commits.</p>
<p>To get the "base" for the merge, look up the common parent of two
commits:</p>
<pre class="screen">$ git merge-base &lt;commit1&gt; &lt;commit2&gt;</pre>
<p>This prints the name of a commit they are both based on. You should
now look up the tree objects of those commits, which you can easily
do with</p>
<pre class="screen">$ git cat-file commit &lt;commitname&gt; | head -1</pre>
<p>since the tree object information is always the first line in a commit
object.</p>
<p>Once you know the three trees you are going to merge (the one "original"
tree, aka the common tree, and the two "result" trees, aka the branches
you want to merge), you do a "merge" read into the index. This will
complain if it has to throw away your old index contents, so you should
make sure that you’ve committed those—​in fact you would normally
always do a merge against your last commit (which should thus match what
you have in your current index anyway).</p>
<p>To do the merge, do</p>
<pre class="screen">$ git read-tree -m -u &lt;origtree&gt; &lt;yourtree&gt; &lt;targettree&gt;</pre>
<p>which will do all trivial merge operations for you directly in the
index file, and you can just write the result out with
<code class="literal">git write-tree</code>.</p>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="merging-multiple-trees-2"></a>Merging multiple trees, continued</h2></div></div></div>
...
<p>You can examine such index state with <code class="literal">git ls-files --unmerged</code>
command.  An example:</p>
<pre class="screen">$ git read-tree -m $orig HEAD $target
$ git ls-files --unmerged
100644 263414f423d0e4d70dae8fe53fa34614ff3e2860 1       hello.c
100644 06fa6a24256dc7e560efa5687fa84b51f0263c3a 2       hello.c
100644 cc44c73eb783565da5831b4d820c962954019b69 3       hello.c</pre>
<p>Each line of the <code class="literal">git ls-files --unmerged</code> output begins with
...
the <code class="literal">HEAD</code> tree, and stage 3 to the <code class="literal">$target</code> tree.</p>
...
the blob objects from these three stages yourself, like this:</p>
<pre class="screen">$ git cat-file blob 263414f &gt;hello.c~1
$ git cat-file blob 06fa6a2 &gt;hello.c~2
$ git cat-file blob cc44c73 &gt;hello.c~3
$ git merge-file hello.c~2 hello.c~1 hello.c~3</pre>
<p>This would leave the merge result in <code class="literal">hello.c~2</code> file, along
with conflict markers if there are conflicts.  After verifying
the merge result makes sense, you can tell Git what the final
merge result for this file is by:</p>
<pre class="screen">$ mv -f hello.c~2 hello.c
$ git update-index hello.c</pre>
<p>When a path is in the "unmerged" state, running <code class="literal">git update-index</code> for
...
<pre class="screen">$ git merge-index git-merge-one-file hello.c</pre>
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="object-details"></a>Object storage format</h2></div></div></div>

<p>All objects have a statically determined "type" which identifies the
...
for <span class="emphasis"><em>file</em></span>.</p>
...
&lt;byte\0&gt; + &lt;binary object data&gt;</code>.</p>
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="birdview-on-the-source-code"></a>A birds-eye view of Git’s source code</h2></div></div></div>

<p>It is not always easy for new developers to find their way through Git’s
source code.  This section gives you a little guidance to show where to
start.</p>
<p>A good place to start is with the contents of the initial commit, with:</p>
<pre class="screen">$ git switch --detach e83c5163</pre>
<p>The initial revision lays the foundation for almost everything Git has
today, but is small enough to read in one sitting.</p>
<p>Note that terminology has changed since that revision.  For example, the
README in that revision uses the word "changeset" to describe what we
now call a <a class="link" href="#def_commit_object">commit</a>.</p>
<p>Also, we do not call it "cache" any more, but rather "index"; however, the
file is still called <code class="literal">cache.h</code>.  Remark: Not much reason to change it now,
especially since there is no good single name for it anyway, because it is
basically <span class="emphasis"><em>the</em></span> header file which is included by <span class="emphasis"><em>all</em></span> of Git’s C sources.</p>
<p>If you grasp the ideas in that initial commit, you should check out a
more recent version and skim <code class="literal">cache.h</code>, <code class="literal">object.h</code> and <code class="literal">commit.h</code>.</p>
<p>In the early days, Git (in the tradition of UNIX) was a bunch of programs
which were extremely simple, and which you used in scripts, piping the
output of one into another. This turned out to be good for initial
development, since it was easier to test new things.  However, recently
many of these parts have become builtins, and some of the core has been
"libified", i.e. put into libgit.a for performance, portability reasons,
and to avoid code duplication.</p>
<p>By now, you know what the index is (and find the corresponding data
...
get at the object name and flags).</p>
<p>Now is a good point to take a break to let this information sink in.</p>
<p>Next step: get familiar with the object naming.  Read <a class="xref" href="#naming-commits" title="Naming commits">the section called “Naming commits”</a>.
...
functions like <code class="literal">get_sha1_basic()</code> or the likes.</p>
<p>This is just to get you into the groove for the most libified part of Git:
the revision walker.</p>
<p>Basically, the initial version of <code class="literal">git log</code> was a shell script:</p>
<pre class="screen">$ git-rev-list --pretty $(git-rev-parse --default HEAD "$@") | \
        LESS=-S ${PAGER:-less}</pre>
<p>What does this mean?</p>
<p><code class="literal">git rev-list</code> is the original version of the revision walker, which
<span class="emphasis"><em>always</em></span> printed a list of revisions to stdout.  It is still functional,
and needs to, since most new Git commands start out as scripts using
<code class="literal">git rev-list</code>.</p>
<p><code class="literal">git rev-parse</code> is not as important any more; it was only used to filter out
options that were relevant for the different plumbing commands that were
called by the script.</p>
<p>Most of what <code class="literal">git rev-list</code> did is contained in <code class="literal">revision.c</code> and
<code class="literal">revision.h</code>.  It wraps the options in a struct named <code class="literal">rev_info</code>, which
controls how and what revisions are walked, and more.</p>
<p>The original job of <code class="literal">git rev-parse</code> is now taken by the function
...
commits one by one with the function <code class="literal">get_revision()</code>.</p>
<p>If you are interested in more details of the revision walking process,
...
no longer need to call <code class="literal">setup_pager()</code> directly).</p>
<p>Nowadays, <code class="literal">git log</code> is a builtin, which means that it is <span class="emphasis"><em>contained</em></span> in the
command <code class="literal">git</code>.  The source side of a builtin is</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<p>Sometimes, more than one builtin is contained in one source file.  For
...
<code class="literal">BUILT_INS</code> in the <code class="literal">Makefile</code>.</p>
<p><code class="literal">git log</code> looks more complicated in C than it does in the original script,
but that allows for a much greater flexibility and performance.</p>
<p>Here again it is a good point to take a pause.</p>
<p>Lesson three is: study the code.  Really, it is the best way to learn about
the organization of Git (after you know the basic concepts).</p>
<p>So, think about something which you are interested in, say, "how can I
access a blob just knowing the object name of it?".  The first step is to
find a Git command with which you can do it.  In this example, it is either
<code class="literal">git show</code> or <code class="literal">git cat-file</code>.</p>
<p>For the sake of clarity, let’s stay with <code class="literal">git cat-file</code>, because it</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
is plumbing, and
</li><li class="listitem">
...
<p>So, look into <code class="literal">builtin/cat-file.c</code>, search for <code class="literal">cmd_cat_file()</code> and look what
it does.</p>
<pre class="screen">        git_config(git_default_config);
        if (argc != 3)
                usage("git cat-file [-t|-s|-e|-p|&lt;type&gt;] &lt;sha1&gt;");
        if (get_sha1(argv[2], sha1))
                die("Not a valid object name %s", argv[2]);</pre>
<p>Let’s skip over the obvious details; the only really interesting part
...
repository, it writes the resulting SHA-1 into the variable <code class="literal">sha1</code>.</p>
<p>Two things are interesting here:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
the source.</p>
<p>To find out how the result can be used, just read on in <code class="literal">cmd_cat_file()</code>:</p>
<pre class="screen">        write_or_die(1, buf, size);</pre>
<p>Sometimes, you do not know where to look for a feature.  In many such cases,
...
<p>Example: If you know that there was some test case for <code class="literal">git bundle</code>, but
...
does not illustrate the point!):</p>
<pre class="screen">$ git log --no-merges t/</pre>
<p>In the pager (<code class="literal">less</code>), just search for "bundle", go a few lines back,
and see that it is in commit 18449ab0.  Now just copy this object name,
and paste it into the command line</p>
<pre class="screen">$ git show 18449ab0</pre>
<p>Voila.</p>
<p>Another example: Find out what to do in order to make some script a
builtin:</p>
<pre class="screen">$ git log --no-merges --diff-filter=A builtin/*.c</pre>
<p>You see, Git is actually the best tool to find out about the source of Git
itself!</p>
</div>
</div>
...
<div class="variablelist"><dl class="variablelist"><dt><span class="term"><a name="def_alternate_object_database"></a>alternate object database</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_bare_repository"></a>bare repository</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_blob_object"></a>blob object</span></dt><dd>
Untyped <a class="link" href="#def_object">object</a>, e.g. the contents of a file.
</dd><dt><span class="term"><a name="def_branch"></a>branch</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_cache"></a>cache</span></dt><dd>
Obsolete for: <a class="link" href="#def_index">index</a>.
</dd><dt><span class="term"><a name="def_chain"></a>chain</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_changeset"></a>changeset</span></dt><dd>
BitKeeper/cvsps speak for "<a class="link" href="#def_commit">commit</a>". Since Git does not
store changes, but states, it really does not make sense to use the term
"changesets" with Git.
</dd><dt><span class="term"><a name="def_checkout"></a>checkout</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_cherry-picking"></a>cherry-picking</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_clean"></a>clean</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_commit"></a>commit</span></dt><dd>
<p class="simpara">As a noun: A single point in the
Git history; the entire history of a project is represented as a
set of interrelated commits.  The word "commit" is often
used by Git in the same places other revision control systems
use the words "revision" or "version".  Also used as a short
hand for <a class="link" href="#def_commit_object">commit object</a>.</p>
<p class="simpara">As a verb: The action of storing a new snapshot of the project’s
...
</dd><dt><span class="term"><a name="def_commit_object"></a>commit object</span></dt><dd>
...
revision.
</dd><dt><span class="term"><a name="def_commit-ish"></a>commit-ish (also committish)</span></dt><dd>
...
commit object,
etc.
</dd><dt><span class="term"><a name="def_core_git"></a>core Git</span></dt><dd>
Fundamental data structures and utilities of Git. Exposes only limited
source code management tools.
</dd><dt><span class="term"><a name="def_DAG"></a>DAG</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_dangling_object"></a>dangling object</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_detached_HEAD"></a>detached HEAD</span></dt><dd>
<p class="simpara">Normally the <a class="link" href="#def_HEAD">HEAD</a> stores the name of a
...
"detached".</p>
<p class="simpara">Note that commands that operate on the history of the current branch
...
</dd><dt><span class="term"><a name="def_directory"></a>directory</span></dt><dd>
The list you get with "ls" :-)
</dd><dt><span class="term"><a name="def_dirty"></a>dirty</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_evil_merge"></a>evil merge</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_fast_forward"></a>fast-forward</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_fetch"></a>fetch</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_file_system"></a>file system</span></dt><dd>
Linus Torvalds originally designed Git to be a user space file system,
i.e. the infrastructure to hold files and directories. That ensured the
efficiency and speed of Git.
</dd><dt><span class="term"><a name="def_git_archive"></a>Git archive</span></dt><dd>
Synonym for <a class="link" href="#def_repository">repository</a> (for arch people).
</dd><dt><span class="term"><a name="def_gitfile"></a>gitfile</span></dt><dd>
A plain file <code class="literal">.git</code> at the root of a working tree that
points at the directory that is the real repository.
</dd><dt><span class="term"><a name="def_grafts"></a>grafts</span></dt><dd>
<p class="simpara">Grafts enables two otherwise different lines of development to be joined
...
created. Configured via the <code class="literal">.git/info/grafts</code> file.</p>
<p class="simpara">Note that the grafts mechanism is outdated and can lead to problems
...
</dd><dt><span class="term"><a name="def_hash"></a>hash</span></dt><dd>
In Git’s context, synonym for <a class="link" href="#def_object_name">object name</a>.
</dd><dt><span class="term"><a name="def_head"></a>head</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_head_ref"></a>head ref</span></dt><dd>
A synonym for <a class="link" href="#def_head">head</a>.
</dd><dt><span class="term"><a name="def_hook"></a>hook</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_index"></a>index</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_index_entry"></a>index entry</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_master"></a>master</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_merge"></a>merge</span></dt><dd>
<p class="simpara">As a verb: To bring the contents of another
...
merge.</p>
<p class="simpara">As a noun: unless it is a <a class="link" href="#def_fast_forward">fast-forward</a>, a
...
"merge".</p>
</dd><dt><span class="term"><a name="def_object"></a>object</span></dt><dd>
The unit of storage in Git. It is uniquely identified by the
<a class="link" href="#def_SHA1">SHA-1</a> of its contents. Consequently, an
object cannot be changed.
</dd><dt><span class="term"><a name="def_object_database"></a>object database</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_object_identifier"></a>object identifier</span></dt><dd>
Synonym for <a class="link" href="#def_object_name">object name</a>.
</dd><dt><span class="term"><a name="def_object_name"></a>object name</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_object_type"></a>object type</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_octopus"></a>octopus</span></dt><dd>
To <a class="link" href="#def_merge">merge</a> more than two <a class="link" href="#def_branch">branches</a>.
</dd><dt><span class="term"><a name="def_origin"></a>origin</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_overlay"></a>overlay</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_pack"></a>pack</span></dt><dd>
A set of objects which have been compressed into one file (to save space
or to transmit them efficiently).
</dd><dt><span class="term"><a name="def_pack_index"></a>pack index</span></dt><dd>
The list of identifiers, and other information, of the objects in a
<a class="link" href="#def_pack">pack</a>, to assist in efficiently accessing the contents of a
pack.
</dd><dt><span class="term"><a name="def_pathspec"></a>pathspec</span></dt><dd>
<p class="simpara">Pattern used to limit paths in Git commands.</p>
<p class="simpara">Pathspecs are used on the command line of "git ls-files", "git
...
<p class="simpara">For example, Documentation/*.jpg will match all .jpg files
in the Documentation subtree,
including Documentation/chapter_1/figure_1.jpg.</p>
<p class="simpara">A pathspec that begins with a colon <code class="literal">:</code> has special meaning.  In the
...
<p class="simpara">In the long form, the leading colon <code class="literal">:</code> is followed by an open
...
against the path.</p>
<p class="simpara">A pathspec with only a colon means "there is no pathspec". This form
should not be combined with other pathspec.</p>
<div class="variablelist"><dl class="variablelist"><dt><span class="term">top</span></dt><dd>
The magic word <code class="literal">top</code> (magic signature: <code class="literal">/</code>) makes the pattern
match from the root of the working tree, even when you are
running the command from inside a subdirectory.
</dd><dt><span class="term">literal</span></dt><dd>
Wildcards in the pattern such as <code class="literal">*</code> or <code class="literal">?</code> are treated
as literal characters.
</dd><dt><span class="term">icase</span></dt><dd>
Case insensitive match.
</dd><dt><span class="term">glob</span></dt><dd>
<p class="simpara">Git treats the pattern as a shell glob suitable for
consumption by fnmatch(3) with the FNM_PATHNAME flag:
wildcards in the pattern will not match a / in the pathname.
For example, "Documentation/*.html" matches
"Documentation/git.html" but not "Documentation/ppc/ppc.html"
or "tools/perf/Documentation/perf.html".</p>
<p class="simpara">Two consecutive asterisks ("<code class="literal">**</code>") in patterns matched against
...
<p class="simpara">Other consecutive asterisks are considered invalid.</p>
<p class="simpara">Glob magic is incompatible with literal magic.</p>
</li></ul></div>
</dd><dt><span class="term">attr</span></dt><dd>
<p class="simpara">After <code class="literal">attr:</code> comes a space separated list of "attribute
requirements", all of which must be met in order for the
path to be considered a match; this is in addition to the
usual non-magic pathspec pattern matching.
See <a class="ulink" href="gitattributes.html" target="_top">gitattributes(5)</a>.</p>
<p class="simpara">Each of the attribute requirements for the path takes one of
these forms:</p>
<div class="itemizedlist"><ul class="itemizedlist" style="list-style-type: disc; "><li class="listitem">
...
<p class="simpara">"<code class="literal">!ATTR</code>" requires that the attribute <code class="literal">ATTR</code> be
unspecified.</p>
<p class="simpara">Note that when matching against a tree object, attributes are still
...
</dd><dt><span class="term"><a name="def_parent"></a>parent</span></dt><dd>
A <a class="link" href="#def_commit_object">commit object</a> contains a (possibly empty) list
of the logical predecessor(s) in the line of development, i.e. its
parents.
</dd><dt><span class="term"><a name="def_pickaxe"></a>pickaxe</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_plumbing"></a>plumbing</span></dt><dd>
Cute name for <a class="link" href="#def_core_git">core Git</a>.
</dd><dt><span class="term"><a name="def_porcelain"></a>porcelain</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_per_worktree_ref"></a>per-worktree ref</span></dt><dd>
...
unusual refs.
</dd><dt><span class="term"><a name="def_pseudoref"></a>pseudoref</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_pull"></a>pull</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_push"></a>push</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_reachable"></a>reachable</span></dt><dd>
...
that they contain.
</dd><dt><span class="term"><a name="def_rebase"></a>rebase</span></dt><dd>
...
to the result.
</dd><dt><span class="term"><a name="def_ref"></a>ref</span></dt><dd>
<p class="simpara">A name that begins with <code class="literal">refs/</code> (e.g. <code class="literal">refs/heads/master</code>)
...
for details.
Refs are stored in the <a class="link" href="#def_repository">repository</a>.</p>
<p class="simpara">The ref namespace is hierarchical.
Different subhierarchies are used for different purposes (e.g. the
<code class="literal">refs/heads/</code> hierarchy is used to represent local branches).</p>
<p class="simpara">There are a few special-purpose refs that do not begin with <code class="literal">refs/</code>.
The most notable example is <code class="literal">HEAD</code>.</p>
</dd><dt><span class="term"><a name="def_reflog"></a>reflog</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_refspec"></a>refspec</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_remote"></a>remote repository</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_remote_tracking_branch"></a>remote-tracking branch</span></dt><dd>
...
commits made to it.
</dd><dt><span class="term"><a name="def_repository"></a>repository</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_resolve"></a>resolve</span></dt><dd>
The action of fixing up manually what a failed automatic
<a class="link" href="#def_merge">merge</a> left behind.
</dd><dt><span class="term"><a name="def_revision"></a>revision</span></dt><dd>
Synonym for <a class="link" href="#def_commit">commit</a> (the noun).
</dd><dt><span class="term"><a name="def_rewind"></a>rewind</span></dt><dd>
To throw away part of the development, i.e. to assign the
<a class="link" href="#def_head">head</a> to an earlier <a class="link" href="#def_revision">revision</a>.
</dd><dt><span class="term"><a name="def_SCM"></a>SCM</span></dt><dd>
Source code management (tool).
</dd><dt><span class="term"><a name="def_SHA1"></a>SHA-1</span></dt><dd>
"Secure Hash Algorithm 1"; a cryptographic hash function.
In the context of Git used as a synonym for <a class="link" href="#def_object_name">object name</a>.
</dd><dt><span class="term"><a name="def_shallow_clone"></a>shallow clone</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_shallow_repository"></a>shallow repository</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_stash"></a>stash entry</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_submodule"></a>submodule</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_superproject"></a>superproject</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_symref"></a>symref</span></dt><dd>
...
command.
</dd><dt><span class="term"><a name="def_tag"></a>tag</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_tag_object"></a>tag object</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_topic_branch"></a>topic branch</span></dt><dd>
...
related changes.
</dd><dt><span class="term"><a name="def_tree"></a>tree</span></dt><dd>
Either a <a class="link" href="#def_working_tree">working tree</a>, or a <a class="link" href="#def_tree_object">tree
object</a> together with the dependent <a class="link" href="#def_blob_object">blob</a> and tree objects
(i.e. a stored representation of a working tree).
</dd><dt><span class="term"><a name="def_tree_object"></a>tree object</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_tree-ish"></a>tree-ish (also treeish)</span></dt><dd>
...
object,
etc.
</dd><dt><span class="term"><a name="def_unmerged_index"></a>unmerged index</span></dt><dd>
An <a class="link" href="#def_index">index</a> which contains unmerged
<a class="link" href="#def_index_entry">index entries</a>.
</dd><dt><span class="term"><a name="def_unreachable_object"></a>unreachable object</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_upstream_branch"></a>upstream branch</span></dt><dd>
...
</dd><dt><span class="term"><a name="def_working_tree"></a>working tree</span></dt><dd>
...
<div class="appendix"><div class="titlepage"><div><div><h1 class="title"><a name="git-quick-start"></a>Appendix A. Git Quick Reference</h1></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl class="toc"><dt><span class="section"><a href="#quick-creating-a-new-repository">Creating a new repository</a></span></dt><dt><span class="section"><a href="#managing-branches">Managing branches</a></span></dt><dt><span class="section"><a href="#exploring-history">Exploring history</a></span></dt><dt><span class="section"><a href="#making-changes">Making changes</a></span></dt><dt><span class="section"><a href="#merging">Merging</a></span></dt><dt><span class="section"><a href="#sharing-your-changes">Sharing your changes</a></span></dt><dt><span class="section"><a href="#repository-maintenance">Repository maintenance</a></span></dt></dl></div>

<p>This is a quick summary of the major commands; the previous chapters
explain how these work in more detail.</p>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="quick-creating-a-new-repository"></a>Creating a new repository</h2></div></div></div>

<p>From a tarball:</p>
<pre class="screen">$ tar xzf project.tar.gz
$ cd project
$ git init
Initialized empty Git repository in .git/
$ git add .
$ git commit</pre>
<p>From a remote repository:</p>
<pre class="screen">$ git clone git://example.com/pub/project.git
$ cd project</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="managing-branches"></a>Managing branches</h2></div></div></div>

<pre class="screen">$ git branch                    # list all local branches in this repo
$ git switch test               # switch working directory to branch "test"
$ git branch new                # create branch "new" starting at current HEAD
$ git branch -d new             # delete branch "new"</pre>
<p>Instead of basing a new branch on current HEAD (the default), use:</p>
<pre class="screen">$ git branch new test    # branch named "test"
$ git branch new v2.6.15 # tag named v2.6.15
$ git branch new HEAD^   # commit before the most recent
$ git branch new HEAD^^  # commit before that
$ git branch new test~10 # ten commits before tip of branch "test"</pre>
<p>Create and switch to a new branch at the same time:</p>
<pre class="screen">$ git switch -c new v2.6.15</pre>
<p>Update and examine branches from the repository you cloned from:</p>
<pre class="screen">$ git fetch             # update
$ git branch -r         # list
  origin/master
  origin/next
  ...
$ git switch -c masterwork origin/master</pre>
<p>Fetch a branch from a different repository, and give it a new
name in your repository:</p>
<pre class="screen">$ git fetch git://example.com/project.git theirbranch:mybranch
$ git fetch git://example.com/project.git v2.6.15:mybranch</pre>
<p>Keep a list of repositories you work with regularly:</p>
<pre class="screen">$ git remote add example git://example.com/project.git
...
$ git branch -r                 # list all remote branches</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="exploring-history"></a>Exploring history</h2></div></div></div>

<pre class="screen">$ gitk                      # visualize and browse history
...
$ git show v2.6.15:a.txt    # look at old version of a.txt</pre>
<p>Search for regressions:</p>
<pre class="screen">$ git bisect start
...
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="making-changes"></a>Making changes</h2></div></div></div>

<p>Make sure Git knows who to blame:</p>
<pre class="screen">$ cat &gt;&gt;~/.gitconfig &lt;&lt;\EOF
[user]
        name = Your Name Comes Here
        email = you@yourdomain.example.com
EOF</pre>
<p>Select file contents to include in the next commit, then make the
commit:</p>
<pre class="screen">$ git add a.txt    # updated file
$ git add b.txt    # new file
$ git rm c.txt     # old file
$ git commit</pre>
<p>Or, prepare and create the commit in one step:</p>
<pre class="screen">$ git commit d.txt # use latest content only of d.txt
$ git commit -a    # use latest content of all tracked files</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="merging"></a>Merging</h2></div></div></div>

<pre class="screen">$ git merge test   # merge branch "test" into the current branch
$ git pull git://example.com/project.git master
                   # fetch and merge in remote branch
$ git pull . test  # equivalent to git merge test</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="sharing-your-changes"></a>Sharing your changes</h2></div></div></div>

<p>Importing or exporting patches:</p>
<pre class="screen">$ git format-patch origin..HEAD # format a patch for each commit
                                # in HEAD but not in origin
$ git am mbox # import patches from the mailbox "mbox"</pre>
<p>Fetch a branch in a different Git repository, then merge into the
current branch:</p>
<pre class="screen">$ git pull git://example.com/project.git theirbranch</pre>
<p>Store the fetched branch into a local branch before merging into the
current branch:</p>
<pre class="screen">$ git pull git://example.com/project.git theirbranch:mybranch</pre>
<p>After creating commits on a local branch, update the remote
branch with your commits:</p>
<pre class="screen">$ git push ssh://example.com/project.git mybranch:theirbranch</pre>
<p>When remote and local branch are both named "test":</p>
<pre class="screen">$ git push ssh://example.com/project.git test</pre>
<p>Shortcut version for a frequently used remote repository:</p>
<pre class="screen">$ git remote add example ssh://example.com/project.git
$ git push example test</pre>
</div>
<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="repository-maintenance"></a>Repository maintenance</h2></div></div></div>

<p>Check for corruption:</p>
<pre class="screen">$ git fsck</pre>
<p>Recompress, remove unused cruft:</p>
<pre class="screen">$ git gc</pre>
</div>
</div>
<div class="appendix"><div class="titlepage"><div><div><h1 class="title"><a name="todo"></a>Appendix B. Notes and todo list for this manual</h1></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl class="toc"><dt><span class="section"><a href="#todo-list">Todo list</a></span></dt></dl></div>

<div class="section"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><a name="todo-list"></a>Todo list</h2></div></div></div>
...
provides.</p>
<p>Add more good examples.  Entire sections of just cookbook examples
might be a good idea; maybe make an "advanced examples" section a
standard end-of-chapter section?</p>
<p>Include cross-references to the glossary, where appropriate.</p>
<p>Add a section on working with other version control systems, including
CVS, Subversion, and just imports of series of release tarballs.</p>
<p>Write a chapter on using plumbing and writing scripts.</p>
<p>Alternates, clone -reference, etc.</p>
<p>More on recovery from repository corruption.  See:
	...
	<a class="ulink" href="https://lore.kernel.org/git/Pine.LNX.4.64.0702141033400.3604@woody.linux-foundation.org/" target="_top">https://lore.kernel.org/git/Pine.LNX.4.64.0702141033400.3604@woody.linux-foundation.org/</a></p>
</div>
</div>
</div></body></html>
