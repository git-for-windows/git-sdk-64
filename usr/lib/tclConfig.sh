...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib -ltcl8.6'
...
TCL_PACKAGE_PATH='/usr/lib/tcl8.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib -ltclstub8.6'
