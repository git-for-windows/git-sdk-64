...
die "$0: Perl lib version (5.42.3) doesn't match executable '$^X' version ($])"
    unless $^V;

$^V eq 5.42.3
    or die sprintf "%s: Perl lib version (5.42.3) doesn't match executable '$^X' version (%vd)", $0, $^V;
