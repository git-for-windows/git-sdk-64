...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDLIBRARY': 'libpython3.11.dll.a',
 ...
 'CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona -msahf -mtune=generic '
           '-O2 -pipe -march=nocona -msahf -mtune=generic -O2 -pipe',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/c/S/B/src/Python-3.11.9/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/c/S/B/src/Python-3.11.9/lcov-report',
 ...
 'DLINCLDIR': '.',
 'DLLLIBRARY': 'msys-python3.11.dll',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311-x86_64-msys.dll',
 'FILEMODE': 644,
 ...
 'LIBPL': '/usr/lib/python3.11/config-3.11-x86_64-msys',
 ...
 'LINK_PYTHON_OBJS': 'libpython3.11.dll.a',
 'LIPO_32BIT_FLAGS': '',
 'LIPO_INTEL64_FLAGS': '',
 'LLVM_PROF_ERR': 'no',
 'LLVM_PROF_FILE': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-DNDEBUG -g -fwrapv -O3 -Wall -march=nocona '
                             '-msahf -mtune=generic -O2 -pipe -march=nocona '
                             '-msahf -mtune=generic -O2 -pipe -std=c11 '
                             '-Werror=implicit-function-declaration '
 ...
 'abs_builddir': '/c/S/B/src/Python-3.11.9',
 'abs_srcdir': '/c/S/B/src/Python-3.11.9',
