...
itcl_LIB_FILE=libitcl4.2.0.dll
ITCL_LIB_FILE=libitcl4.2.0.dll
...
# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-L/usr/lib/itcl4.2.0 -litcl4.2.0'
ITCL_LIB_SPEC='-L/usr/lib/itcl4.2.0 -litcl4.2.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-L/usr/lib/itcl4.2.0 -litclstub4.2.0'
ITCL_STUB_LIB_SPEC='-L/usr/lib/itcl4.2.0 -litclstub4.2.0'
...
# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='/usr/lib/itcl4.2.0/libitclstub4.2.0.a'
ITCL_STUB_LIB_PATH='/usr/lib/itcl4.2.0/libitclstub4.2.0.a'
