...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--build=x86_64-pc-msys' '--prefix=/usr' '--enable-shared' '--enable-ipv6' '--with-libc=' '--with-libm=' '--with-system-expat' '--with-system-ffi' '--with-threads' 'ac_cv_func_bind_textdomain_codeset=yes' 'CPPFLAGS=-D_FORTIFY_SOURCE=2 -I/usr/include/ncursesw' 'LDFLAGS=-pipe -s  -L.' 'build_alias=x86_64-pc-msys' 'CFLAGS=-march=x86-64 -mtune=generic -O2 -pipe -DNDEBUG ' 'PKG_CONFIG_PATH=/usr/lib/pkgconfig:/usr/share/pkgconfig:/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-msys:lib-tk:lib-old',
 'COVERAGE_INFO': '/msys_scripts/python2/src/Python-2.7.13/coverage.info',
 'COVERAGE_REPORT': '/msys_scripts/python2/src/Python-2.7.13/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov report"',
 'CPPFLAGS': '-I. -IInclude -I./Include -D_FORTIFY_SOURCE=2 -I/usr/include/ncursesw',
 'CXX': 'g++',
 'C_THREADS': 0,
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-fno-strict-aliasing -march=x86-64 -mtune=generic -O2 -pipe -DNDEBUG  -DNDEBUG -march=x86-64 -mtune=generic -O2 -pipe -DNDEBUG -I. -IInclude -I./Include -D_FORTIFY_SOURCE=2 -I/usr/include/ncursesw  -DPy_BUILD_CORE',
 ...
 'abs_builddir': '/msys_scripts/python2/src/Python-2.7.13',
 'abs_srcdir': '/msys_scripts/python2/src/Python-2.7.13',
