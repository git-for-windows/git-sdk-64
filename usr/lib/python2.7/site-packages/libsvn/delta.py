...
_delta.SVN_DELTA_COMPRESSION_LEVEL_NONE_swigconstant(_delta)
SVN_DELTA_COMPRESSION_LEVEL_NONE = _delta.SVN_DELTA_COMPRESSION_LEVEL_NONE

_delta.SVN_DELTA_COMPRESSION_LEVEL_MAX_swigconstant(_delta)
SVN_DELTA_COMPRESSION_LEVEL_MAX = _delta.SVN_DELTA_COMPRESSION_LEVEL_MAX

_delta.SVN_DELTA_COMPRESSION_LEVEL_DEFAULT_swigconstant(_delta)
...
_delta.svn_txdelta_source_swigconstant(_delta)
svn_txdelta_source = _delta.svn_txdelta_source

_delta.svn_txdelta_target_swigconstant(_delta)
svn_txdelta_target = _delta.svn_txdelta_target

_delta.svn_txdelta_new_swigconstant(_delta)
