...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/msys_scripts/python3/src/Python-3.6.6/coverage.info',
 'COVERAGE_REPORT': '/msys_scripts/python3/src/Python-3.6.6/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -march=x86-64 -mtune=generic -O2 -pipe -std=c99 '
                   '-Wextra -Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -I. -I/Include '
                   '-I/usr/include/ncursesw  -DPy_BUILD_CORE',
 ...
 'abs_builddir': '/msys_scripts/python3/src/Python-3.6.6',
 'abs_srcdir': '/msys_scripts/python3/src/Python-3.6.6',
