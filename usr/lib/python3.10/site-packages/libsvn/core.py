...
def svn_ver_compatible(my_version: "svn_version_t", lib_version: "svn_version_t") -> "svn_boolean_t":
...
def svn_ver_equal(my_version: "svn_version_t", lib_version: "svn_version_t") -> "svn_boolean_t":
...
def svn_ver_check_list2(my_version: "svn_version_t", checklist: "svn_version_checklist_t", comparator: "svn_boolean_t (*)(svn_version_t const *,svn_version_t const *)") -> "svn_error_t *":
...
def svn_ver_check_list(my_version: "svn_version_t", checklist: "svn_version_checklist_t") -> "svn_error_t *":
...
def svn_version_ext_runtime_osname(ext_info: "svn_version_extended_t") -> "char const *":
...
def svn_version_ext_linked_libs(ext_info: "svn_version_extended_t") -> "apr_array_header_t const *":
...
def svn_version_ext_loaded_libs(ext_info: "svn_version_extended_t") -> "apr_array_header_t const *":
...
def svn_stream_seek(stream: "svn_stream_t", mark: "svn_stream_mark_t") -> "svn_error_t *":
...
def svn_stream_invoke_seek_fn(_obj: "svn_stream_seek_fn_t", baton: "void *", mark: "svn_stream_mark_t") -> "svn_error_t *":
