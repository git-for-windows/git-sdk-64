...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/mingw32' '--host=i686-w64-mingw32' "
                "'--build=i686-w64-mingw32' '--enable-shared' '--with-threads' "
                "'--with-system-expat' '--with-system-ffi' "
                "'--without-ensurepip' 'OPT=' 'build_alias=i686-w64-mingw32' "
                "'host_alias=i686-w64-mingw32' 'CFLAGS=-march=i686 "
                '-mtune=generic -O2 -pipe -fwrapv -D__USE_MINGW_ANSI_STDIO=1  '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -march=i686 '
                   ...
                   '-D__USE_MINGW_ANSI_STDIO=1  -DNDEBUG -march=i686 '
                   '-mtune=generic -O2 -pipe -fwrapv '
