...
module RbConfig
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=i686 -mtune=generic -O2 -pipe -I/mingw32/include/pdcurses -ID:/msys64/mingw32/lib/libffi-3.2.1/include"
  CONFIG["CXX"] = "i686-w64-mingw32-g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048 -ID:/msys64/mingw32/lib/libffi-3.2.1/include -I/mingw32/include/pdcurses -D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -pipe"
  CONFIG["CFLAGS"] = "-march=i686 -mtune=generic -O2 -pipe -I/mingw32/include/pdcurses -ID:/msys64/mingw32/lib/libffi-3.2.1/include"
