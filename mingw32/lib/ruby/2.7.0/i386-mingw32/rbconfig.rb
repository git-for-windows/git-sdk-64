...
module RbConfig
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "i686-w64-mingw32-gcc.exe (Rev2, Built by MSYS2 project) 9.3.0\nCopyright (C) 2019 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-march=i686 -mtune=generic -O2 -pipe -I/mingw32/include/pdcurses -ID:/msys64/mingw32/include"
  CONFIG["CXX"] = "i686-w64-mingw32-g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D__USE_MINGW_ANSI_STDIO=1 -DFD_SETSIZE=2048 -ID:/msys64/mingw32/include -I/mingw32/include/pdcurses -D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -pipe"
  CONFIG["CFLAGS"] = "-march=i686 -mtune=generic -O2 -pipe -I/mingw32/include/pdcurses -ID:/msys64/mingw32/include"
