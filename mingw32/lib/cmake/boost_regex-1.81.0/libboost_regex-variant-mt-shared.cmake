...
if(CMAKE_SIZEOF_VOID_P EQUAL 8)
  _BOOST_SKIPPED("libboost_regex-mt.dll.a" "32 bit, need 64")
  return()
endif()
...
if(DEFINED Boost_USE_STATIC_LIBS)
  ...
  if(WIN32 AND NOT _BOOST_SINGLE_VARIANT)
    _BOOST_SKIPPED("libboost_regex-mt.dll.a" "shared, default on Windows is static, set Boost_USE_STATIC_LIBS=OFF to override")
    return()
  endif()
endif()
