...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden -DMS_DLL_ID=\'"3.9"\'',
 'CONFIGURE_CPPFLAGS': '-I../Python-3.9.6/PC -D__USE_MINGW_ANSI_STDIO=1 '
 ...
 'CONFIG_ARGS': "'--prefix=/mingw32' '--host=i686-w64-mingw32' "
                ...
                "'CC=gcc' 'CFLAGS=-march=i686 -mtune=generic -O2 -pipe -fwrapv "
 ...
 'PY_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                     ...
                     '-Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden -DMS_DLL_ID=\'"3.9"\' -fprofile-use '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -march=i686 '
                   ...
                   '-I../Python-3.9.6/Include/internal -IObjects -IInclude '
                   '-IPython -I. -I../Python-3.9.6/Include '
                   '-I../Python-3.9.6/PC -D__USE_MINGW_ANSI_STDIO=1 '
                   '-ID:/a/_temp/msys/msys64/mingw32/include/ncurses  -I. '
                   '-D__USE_MINGW_ANSI_STDIO=1 '
                   '-ID:/a/_temp/msys/msys64/mingw32/include/ncurses '
