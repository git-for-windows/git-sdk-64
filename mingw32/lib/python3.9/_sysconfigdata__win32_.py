...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-march=i686 -mtune=generic -O2 -pipe -march=i686 -mtune=generic '
           '-O2 -pipe',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-march=i686 -mtune=generic -O2 -pipe',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-DMS_DLL_ID=\'"3.9"\'',
 'CONFIGURE_CPPFLAGS': '-I../Python-3.9.6/PC -D__USE_MINGW_ANSI_STDIO=1 -I.',
 ...
 'CONFIG_ARGS': "'--prefix=/mingw32' '--host=i686-w64-mingw32' "
                ...
                "'host_alias=i686-w64-mingw32' 'CC=gcc' 'CFLAGS=-march=i686 "
                "-mtune=generic -O2 -pipe' 'LDFLAGS=-pipe "
                "-Wl,--dynamicbase,--nxcompat,--no-seh' "
                "'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1' "
                "'PKG_CONFIG_PATH=/mingw32/lib/pkgconfig:/mingw32/share/pkgconfig'",
 'CONFINCLUDEDIR': '/mingw32/include',
 'CONFINCLUDEPY': '/mingw32/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/c/_/M/mingw-w64-python/src/build-i686/coverage.info',
 'COVERAGE_REPORT': '/c/_/M/mingw-w64-python/src/build-i686/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Python-3.9.6/Include '
             '-I../Python-3.9.6/PC -D__USE_MINGW_ANSI_STDIO=1 -I. '
             '-D__USE_MINGW_ANSI_STDIO=1',
 'CXX': 'g++',
 'DESTDIR': '',
 'DESTDIRFINAL': '/',
 'DESTDIRS': '/mingw32 /mingw32/lib /mingw32/lib/python3.9 '
             '/mingw32/lib/python3.9/lib-dynload',
 'DESTLIB': '/mingw32/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/mingw32/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cp39-mingw_i686.pyd',
 'FILEMODE': 644,
 ...
 'INCLDIRSTOMAKE': '/mingw32/include /mingw32/include '
                   '/mingw32/include/python3.9 /mingw32/include/python3.9',
 'INCLUDEDIR': '/mingw32/include',
 'INCLUDEPY': '/mingw32/include/python3.9',
 ...
 'LIBDIR': '/mingw32/lib',
 'LIBFFI_INCLUDEDIR': 'D:/a/_temp/msys/msys64/mingw32/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/mingw32/lib/pkgconfig',
 'LIBPL': '/mingw32/lib/python3.9/config-3.9',
 ...
 'MACHDESTLIB': '/mingw32/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Python-3.9.6/Modules/makesetup',
 ...
 'NCURSESW_INCLUDEDIR': 'D:/a/_temp/msys/msys64/mingw32/include/ncursesw',
 'NO_AS_NEEDED': '-Wl,--no-as-needed',
 'NT_THREADS': 1,
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-ID:/a/_temp/msys/msys64/mingw32/include',
 'OPENSSL_LDFLAGS': '-LD:/a/_temp/msys/msys64/mingw32/lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             '-fwrapv -O3 -Wall -march=i686 -mtune=generic -O2 '
                             '-pipe -march=i686 -mtune=generic -O2 -pipe '
                             ...
                             '-fprofile-correction '
                             '-I../Python-3.9.6/Include/internal -IObjects '
                             '-IInclude -IPython -I. -I../Python-3.9.6/Include '
                             '-I../Python-3.9.6/PC -D__USE_MINGW_ANSI_STDIO=1 '
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv '
                        '-O3 -Wall -march=i686 -mtune=generic -O2 -pipe '
                        '-march=i686 -mtune=generic -O2 -pipe -std=c99 -Wextra '
                        '-Wno-unused-result -Wno-unused-parameter '
                        '-Wno-missing-field-initializers -Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden -D_WIN32_WINNT=0x0601 '
 ...
 'RCFLAGS': '-DFIELD3=6150 -O COFF --target=pe-i386',
 'READELF': 'readelf',
 ...
 'SRCDIRS': 'Parser Parser/pegen Objects Python Modules Modules/_io Programs '
            'PC',
 'SRC_GDB_HOOKS': '../Python-3.9.6/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python.exe ../Python-3.9.6/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3.9 ../Python-3.9.6/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'VENVLAUNCHERDIR': '/mingw32/lib/python3.9/venv/scripts/nt',
 'VERSION': '3.9',
 'VPATH': 'C:/_/M/mingw-w64-python/src/Python-3.9.6',
 'VPATH_b2h': 'C:/_/M/mingw-w64-python/src/Python-3.9.6',
 'WINDOW_HAS_FLAGS': 1,
 'WINDRES': 'windres',
 ...
 'abs_builddir': 'C:/_/M/mingw-w64-python/src/build-i686',
 'abs_builddir_b2h': 'C:/_/M/mingw-w64-python/src/build-i686',
 'abs_srcdir': 'C:/_/M/mingw-w64-python/src/Python-3.9.6',
 'abs_srcdir_b2h': 'C:/_/M/mingw-w64-python/src/Python-3.9.6',
 'datarootdir': '/mingw32/share',
 'exec_prefix': '/mingw32',
 'prefix': 'D:/a/_temp/msys/msys64/mingw32',
 'prefix_b2h': 'D:/a/_temp/msys/msys64/mingw32',
 'srcdir': 'C:/_/M/mingw-w64-python/src/Python-3.9.6',
 'srcdir_b2h': 'C:/_/M/mingw-w64-python/src/Python-3.9.6'}
