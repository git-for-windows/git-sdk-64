...
build_time_vars = {'ABI3DLLLIBRARY': 'libpython3.dll',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
                    ...
                    '-fprofile-correction -I../Python-3.12.10/Include/internal '
                    '-IObjects -IInclude -IPython -I. '
                    '-I../Python-3.12.10/Include -I../Python-3.12.10/PC  -I.',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 ...
 'MODULE__CTYPES_LDFLAGS': '-LD:/a/msys64/mingw32/lib/../lib -lffi -lole32 '
                           '-loleaut32 -luuid',
 ...
 'MODULE__CURSES_CFLAGS': '-DNCURSES_WIDECHAR '
                          '-ID:/a/msys64/mingw32/include/ncursesw',
