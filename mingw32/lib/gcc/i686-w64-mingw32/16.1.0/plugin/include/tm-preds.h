/* Generated automatically by the program 'D:\W\B\src\build-MINGW32\gcc\build\genpreds.exe'
   from the machine description file '../../gcc-16.1.0/gcc/config/i386/i386.md'.  */
...
extern bool x86_64_neg_const_int_operand (rtx, machine_mode);
...
extern bool const0_or_m1_operand (rtx, machine_mode);
...
extern bool cmpps_imm_operand (rtx, machine_mode);
...
extern bool ternlog_operand (rtx, machine_mode);
...
extern bool vector_or_0_or_1s_operand (rtx, machine_mode);
...
extern bool nonimm_or_0_or_1s_operand (rtx, machine_mode);
...
extern bool ieee_maxmin_comparison_operator (rtx, machine_mode);
...
extern bool ix86_trivial_fp_comparison_operator_xf (rtx, machine_mode);
extern bool ix86_fp_comparison_operator (rtx, machine_mode);
extern bool ix86_fp_comparison_operator_xf (rtx, machine_mode);
...
extern bool and_operator (rtx, machine_mode);
...
extern bool extract_high_operator (rtx, machine_mode);
...
extern bool avx_vbroadcast128_operand (rtx, machine_mode);
...
extern bool apx_evex_memory_operand (rtx, machine_mode);
extern bool apx_evex_add_memory_operand (rtx, machine_mode);
