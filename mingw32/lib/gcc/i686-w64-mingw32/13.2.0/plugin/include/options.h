...
enum opt_code
{
  ...
  OPT__param_x86_stlf_window_ninsns_ = 342,  /* --param=x86-stlf-window-ninsns= */
  OPT__param_x86_stv_max_visits_ = 343,      /* --param=x86-stv-max-visits= */
  ...
  OPT_MQ = 408,                              /* -MQ */
  OPT_MT = 409,                              /* -MT */
  OPT_Mmodules = 410,                        /* -Mmodules */
  OPT_Mno_modules = 411,                     /* -Mno-modules */
  OPT_N = 412,                               /* -N */
  OPT_O = 413,                               /* -O */
  OPT_Ofast = 414,                           /* -Ofast */
  OPT_Og = 415,                              /* -Og */
  ...
  OPT_Tbss_ = 426,                           /* -Tbss= */
  OPT_Tdata = 427,                           /* -Tdata */
  OPT_Tdata_ = 428,                          /* -Tdata= */
  OPT_Ttext = 429,                           /* -Ttext */
  OPT_Ttext_ = 430,                          /* -Ttext= */
  OPT_U = 431,                               /* -U */
  /* OPT_W = 432, */                         /* -W */
  OPT_WNSObject_attribute = 433,             /* -WNSObject-attribute */
  OPT_Wa_ = 434,                             /* -Wa, */
  OPT_Wabi = 435,                            /* -Wabi */
  OPT_Wabi_tag = 436,                        /* -Wabi-tag */
  OPT_Wabi_ = 437,                           /* -Wabi= */
  OPT_Wabsolute_value = 438,                 /* -Wabsolute-value */
  OPT_Waddress = 439,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 440,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 441,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 442,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 443,                       /* -Waliasing */
  OPT_Walign_commons = 444,                  /* -Walign-commons */
  /* OPT_Waligned_new = 445, */              /* -Waligned-new */
  OPT_Waligned_new_ = 446,                   /* -Waligned-new= */
  OPT_Wall = 447,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 448,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 449,                     /* -Walloc-zero */
  OPT_Walloca = 450,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 451,            /* -Walloca-larger-than= */
  OPT_Wampersand = 452,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 453,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 454,    /* -Wanalyzer-deref-before-check */
  ...
  OPT_Wanalyzer_exposure_through_uninit_copy = 458,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 459,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 460,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 461,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 462,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 463,      /* -Wanalyzer-fd-type-mismatch */
  ...
  OPT_Wanalyzer_imprecise_fp_arithmetic = 468,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_recursion = 469,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 470,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 471,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 472,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 473,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 474,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 475,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_possible_null_argument = 476,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 477,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 478,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 479,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 480,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 481,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 482,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 483,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 484,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 485,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 486,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 487,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 488,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 489,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 490,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 491,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 492,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 493,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 494,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 495,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 496,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 497,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 498,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 499,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 500,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 501, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 502,                  /* -Warray-bounds= */
  OPT_Warray_compare = 503,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 504, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 505,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 506,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 507,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 508, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 509,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 510,              /* -Wattribute-warning */
  OPT_Wattributes = 511,                     /* -Wattributes */
  OPT_Wattributes_ = 512,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 513,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 514, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 515,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 516,                   /* -Wbool-compare */
  OPT_Wbool_operation = 517,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 518,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 519,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 520,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 521, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 522,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 523,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 524,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 525,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 526,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 527,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 528, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 529,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 530,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 531,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 532, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 533,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 534,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 535,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 536,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 537,                 /* -Wcannot-profile */
  OPT_Wcast_align = 538,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 539,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 540,             /* -Wcast-function-type */
  OPT_Wcast_qual = 541,                      /* -Wcast-qual */
  OPT_Wcast_result = 542,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 543, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 544,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 545,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 546,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 547,           /* -Wcharacter-truncation */
  OPT_Wchkp = 548,                           /* -Wchkp */
  OPT_Wclass_conversion = 549,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 550,                /* -Wclass-memaccess */
  OPT_Wclobbered = 551,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 552,                /* -Wcomma-subscript */
  OPT_Wcomment = 553,                        /* -Wcomment */
  /* OPT_Wcomments = 554, */                 /* -Wcomments */
  OPT_Wcompare_reals = 555,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 556,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 557,        /* -Wconditionally-supported */
  OPT_Wconversion = 558,                     /* -Wconversion */
  OPT_Wconversion_extra = 559,               /* -Wconversion-extra */
  OPT_Wconversion_null = 560,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 561,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 562,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 563,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 564,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 565,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 566,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 567, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 568,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 569,             /* -Wdangling-reference */
  OPT_Wdate_time = 570,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 571,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 572,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 573,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 574,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 575,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 576,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 577,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 578,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 579,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 580,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 581,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 582,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 583,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 584,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 585,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 586,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 587,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 588,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 589,                /* -Wduplicated-cond */
  OPT_Weffc__ = 590,                         /* -Weffc++ */
  OPT_Wempty_body = 591,                     /* -Wempty-body */
  OPT_Wendif_labels = 592,                   /* -Wendif-labels */
  OPT_Wenum_compare = 593,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 594,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 595,              /* -Wenum-int-mismatch */
  OPT_Werror = 596,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 597, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 598,                         /* -Werror= */
  OPT_Wexceptions = 599,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 600,           /* -Wexpansion-to-defined */
  OPT_Wextra = 601,                          /* -Wextra */
  OPT_Wextra_semi = 602,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 603,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 604,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 605,                    /* -Wfloat-equal */
  /* OPT_Wformat = 606, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 607,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 608,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 609,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 610,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 611, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 612,               /* -Wformat-overflow= */
  OPT_Wformat_security = 613,                /* -Wformat-security */
  OPT_Wformat_signedness = 614,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 615, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 616,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 617,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 618,             /* -Wformat-zero-length */
  OPT_Wformat_ = 619,                        /* -Wformat= */
  OPT_Wframe_address = 620,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 621,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 622,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 623,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 624,           /* -Wfunction-elimination */
  /* OPT_Whsa = 625, */                      /* -Whsa */
  OPT_Wif_not_aligned = 626,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 627,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 628,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 629,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 630, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 631,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 632,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 633,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 634,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 635,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 636, */                   /* -Wimport */
  OPT_Winaccessible_base = 637,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 638,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 639,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 640,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 641,             /* -Winit-list-lifetime */
  OPT_Winit_self = 642,                      /* -Winit-self */
  OPT_Winline = 643,                         /* -Winline */
  OPT_Wint_conversion = 644,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 645,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 646,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 647,               /* -Winteger-division */
  OPT_Winterference_size = 648,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 649,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 650,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 651,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 652,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 653,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 654,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 655,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 656,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 657,               /* -Wjump-misses-init */
  OPT_Wl_ = 658,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 659, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 660,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 661,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 662,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 663,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 664,                     /* -Wlogical-op */
  OPT_Wlong_long = 665,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 666,              /* -Wlto-type-mismatch */
  OPT_Wmain = 667,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 668,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 669,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 670,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 671,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 672,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 673,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 674,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 675,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 676,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 677,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 678,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 679,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 680, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 681,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 682, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 683,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 684,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 685,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 686,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 687,       /* -Wmissing-template-keyword */
  OPT_Wmudflap = 688,                        /* -Wmudflap */
  OPT_Wmultichar = 689,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 690,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 691,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 692,                     /* -Wnamespaces */
  OPT_Wnarrowing = 693,                      /* -Wnarrowing */
  OPT_Wnested_externs = 694,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 695, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 696, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 697, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 698, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 699, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 700, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 701,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 702,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 703,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 704,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 705,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 706,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 707, */               /* -Wnormalized */
  OPT_Wnormalized_ = 708,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 709,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 710,                /* -Wobjc-root-class */
  OPT_Wodr = 711,                            /* -Wodr */
  OPT_Wold_style_cast = 712,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 713,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 714,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 715,            /* -Wopenacc-parallelism */
  OPT_Wopenmp_simd = 716,                    /* -Wopenmp-simd */
  OPT_Woverflow = 717,                       /* -Woverflow */
  OPT_Woverlength_strings = 718,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 719, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 720,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 721,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 722,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 723,            /* -Woverwrite-recursive */
  OPT_Wp_ = 724,                             /* -Wp, */
  OPT_Wpacked = 725,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 726,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 727,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 728,                         /* -Wpadded */
  OPT_Wparentheses = 729,                    /* -Wparentheses */
  OPT_Wpedantic = 730,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 731,                  /* -Wpedantic-cast */
  OPT_Wpedantic_ms_format = 732,             /* -Wpedantic-ms-format */
  OPT_Wpedantic_param_names = 733,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 734,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 735, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 736,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 737,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 738,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 739,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 740,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 741,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 742,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 743,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 744,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 745,                       /* -Wprotocol */
  OPT_Wpsabi = 746,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 747,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 748,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 749,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 750,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 751,                /* -Wredundant-decls */
  OPT_Wredundant_move = 752,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 753,                 /* -Wredundant-tags */
  OPT_Wregister = 754,                       /* -Wregister */
  OPT_Wreorder = 755,                        /* -Wreorder */
  OPT_Wrestrict = 756,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 757,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 758,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 759,           /* -Wscalar-storage-order */
  OPT_Wselector = 760,                       /* -Wselector */
  OPT_Wself_move = 761,                      /* -Wself-move */
  OPT_Wsequence_point = 762,                 /* -Wsequence-point */
  OPT_Wshadow = 763,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 764, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 765,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 766, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 767,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 768, */            /* -Wshadow=global */
  OPT_Wshadow_local = 769,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 770,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 771,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 772,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 773, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 774,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 775,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 776,                /* -Wsign-conversion */
  OPT_Wsign_promo = 777,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 778,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 779,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 780,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 781,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 782,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 783,                    /* -Wspeculative */
  OPT_Wstack_protector = 784,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 785,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 786,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 787,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 788,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 789,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 790,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 791,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 792,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 793,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 794,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 795, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 796,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 797,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 798,            /* -Wstringop-truncation */
  OPT_Wstyle = 799,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 800,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 801,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 802,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 803,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 804,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 805,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 806,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 807,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 808,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 809,               /* -Wsuggest-override */
  OPT_Wsurprising = 810,                     /* -Wsurprising */
  OPT_Wswitch = 811,                         /* -Wswitch */
  OPT_Wswitch_bool = 812,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 813,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 814,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 815,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 816,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 817,                      /* -Wsync-nand */
  OPT_Wsynth = 818,                          /* -Wsynth */
  OPT_Wsystem_headers = 819,                 /* -Wsystem-headers */
  OPT_Wtabs = 820,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 821,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 822,           /* -Wtautological-compare */
  OPT_Wtemplates = 823,                      /* -Wtemplates */
  OPT_Wterminate = 824,                      /* -Wterminate */
  OPT_Wtraditional = 825,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 826,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 827,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 828,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 829,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 830,                           /* -Wtsan */
  OPT_Wtype_limits = 831,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 832,            /* -Wundeclared-selector */
  OPT_Wundef = 833,                          /* -Wundef */
  OPT_Wundefined_do_loop = 834,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 835,                      /* -Wunderflow */
  OPT_Wunicode = 836,                        /* -Wunicode */
  ...
  OPT_fset_stack_executable = 1638,          /* -fset-stack-executable */
  OPT_fshared = 1639,                        /* -fshared */
  OPT_fshort_enums = 1640,                   /* -fshort-enums */
  OPT_fshort_wchar = 1641,                   /* -fshort-wchar */
  OPT_fshow_column = 1642,                   /* -fshow-column */
  OPT_fshrink_wrap = 1643,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1644,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1645,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1646,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1647,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1648,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1649,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1650,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1651,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1652,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1653,                /* -fsoft-check-all */
  OPT_fsources = 1654,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1655,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1656,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1657,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1658,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1659,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1660,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1661,                      /* -fsquangle */
  OPT_fssa_backprop = 1662,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1663,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1664,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1665,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1666, */             /* -fstack-check */
  OPT_fstack_check_ = 1667,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1668,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1669,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1670,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1671,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1672,               /* -fstack-protector */
  OPT_fstack_protector_all = 1673,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1674,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1675,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1676,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1677,                   /* -fstack-usage */
  OPT_fstats = 1678,                         /* -fstats */
  OPT_fstdarg_opt = 1679,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1680,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1681, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1682,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1683,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1684, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1685,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1686,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1687,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1688,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1689, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1690,            /* -fstrong-eval-order= */
  OPT_fswig = 1691,                          /* -fswig */
  OPT_fswitch_errors = 1692,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1693,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1694,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1695,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1696, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1697,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1698, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1699,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1700, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1701,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1702,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1703,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1704,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1705,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1706,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1707,                   /* -ftime-report */
  OPT_ftime_report_details = 1708,           /* -ftime-report-details */
  OPT_ftls_model_ = 1709,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1710,              /* -ftoplevel-reorder */
  OPT_ftracer = 1711,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1712,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1713,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1714,                   /* -ftrampolines */
  OPT_ftransition_all = 1715,                /* -ftransition=all */
  OPT_ftransition_field = 1716,              /* -ftransition=field */
  OPT_ftransition_in = 1717,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1718,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1719,          /* -ftransition=templates */
  OPT_ftransition_tls = 1720,                /* -ftransition=tls */
  OPT_ftrapping_math = 1721,                 /* -ftrapping-math */
  OPT_ftrapv = 1722,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1723,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1724,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1725,                      /* -ftree-ccp */
  OPT_ftree_ch = 1726,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1727, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1728,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1729,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1730, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1731,                   /* -ftree-cselim */
  OPT_ftree_dce = 1732,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1733,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1734,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1735,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1736,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1737, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1738,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1739,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1740, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1741,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1742,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1743, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1744,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1745,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1746,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1747,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1748,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1749,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1750,                      /* -ftree-pre */
  OPT_ftree_pta = 1751,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1752,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1753, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1754,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1755,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1756,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1757,                     /* -ftree-slsr */
  OPT_ftree_sra = 1758,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1759, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1760, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1761,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1762,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1763,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1764, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1765,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1766, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1767,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1768,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1769,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1770,         /* -funconstrained-commons */
  OPT_funderscoring = 1771,                  /* -funderscoring */
  OPT_funit_at_a_time = 1772,                /* -funit-at-a-time */
  OPT_funittest = 1773,                      /* -funittest */
  OPT_funreachable_traps = 1774,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1775,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1776,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1777,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1778, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1779,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1780,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1781,                 /* -funsigned-char */
  OPT_funswitch_loops = 1782,                /* -funswitch-loops */
  OPT_funwind_tables = 1783,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1784,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1785,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1786,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1787,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1788,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1789,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1790,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1791,                     /* -fuse-list= */
  OPT_fvar_tracking = 1792,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1793,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1794,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1795,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1796,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1797, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1798,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1799,                   /* -fverbose-asm */
  /* OPT_fversion = 1800, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1801,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1802,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1803,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1804,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1805,                   /* -fvisibility= */
  OPT_fvpt = 1806,                           /* -fvpt */
  OPT_fvtable_gc = 1807,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1808,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1809,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1810,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1811,                     /* -fvtv-debug */
  OPT_fweak = 1812,                          /* -fweak */
  OPT_fweak_templates = 1813,                /* -fweak-templates */
  OPT_fweb = 1814,                           /* -fweb */
  /* OPT_fwhole_file = 1815, */              /* -fwhole-file */
  OPT_fwhole_program = 1816,                 /* -fwhole-program */
  OPT_fwholediv = 1817,                      /* -fwholediv */
  OPT_fwholevalue = 1818,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1819,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1820,             /* -fworking-directory */
  OPT_fwpa = 1821,                           /* -fwpa */
  OPT_fwpa_ = 1822,                          /* -fwpa= */
  OPT_fwrapv = 1823,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1824,                 /* -fwrapv-pointer */
  OPT_fwritable_relocated_rdata = 1825,      /* -fwritable-relocated-rdata */
  OPT_fxref = 1826,                          /* -fxref */
  /* OPT_fzee = 1827, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1828,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1829,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1830,                     /* -fzero-link */
  OPT_g = 1831,                              /* -g */
  OPT_gant = 1832,                           /* -gant */
  OPT_gas_loc_support = 1833,                /* -gas-loc-support */
  OPT_gas_locview_support = 1834,            /* -gas-locview-support */
  OPT_gbtf = 1835,                           /* -gbtf */
  OPT_gcodeview = 1836,                      /* -gcodeview */
  OPT_gcoff = 1837,                          /* -gcoff */
  OPT_gcoff1 = 1838,                         /* -gcoff1 */
  OPT_gcoff2 = 1839,                         /* -gcoff2 */
  OPT_gcoff3 = 1840,                         /* -gcoff3 */
  OPT_gcolumn_info = 1841,                   /* -gcolumn-info */
  OPT_gctf = 1842,                           /* -gctf */
  OPT_gdescribe_dies = 1843,                 /* -gdescribe-dies */
  OPT_gdwarf = 1844,                         /* -gdwarf */
  OPT_gdwarf_ = 1845,                        /* -gdwarf- */
  OPT_gdwarf32 = 1846,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1847,                       /* -gdwarf64 */
  OPT_gen_decls = 1848,                      /* -gen-decls */
  OPT_ggdb = 1849,                           /* -ggdb */
  OPT_ggnu_pubnames = 1850,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1851,                   /* -gimple-stats */
  OPT_ginline_points = 1852,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1853, /* -ginternal-reset-location-views */
  OPT_gnat = 1854,                           /* -gnat */
  OPT_gnatO = 1855,                          /* -gnatO */
  OPT_gno_ = 1856,                           /* -gno- */
  OPT_gno_pubnames = 1857,                   /* -gno-pubnames */
  OPT_gpubnames = 1858,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1859,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1860,                   /* -gsplit-dwarf */
  OPT_gstabs = 1861,                         /* -gstabs */
  OPT_gstabs_ = 1862,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1863,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1864,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1865,                        /* -gtoggle */
  OPT_gvariable_location_views = 1866,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1867,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1868,                           /* -gvms */
  OPT_gxcoff = 1869,                         /* -gxcoff */
  OPT_gxcoff_ = 1870,                        /* -gxcoff+ */
  OPT_gz = 1871,                             /* -gz */
  OPT_gz_ = 1872,                            /* -gz= */
  OPT_h = 1873,                              /* -h */
  OPT_help = 1874,                           /* -help */
  OPT_idirafter = 1875,                      /* -idirafter */
  OPT_imacros = 1876,                        /* -imacros */
  OPT_imultiarch = 1877,                     /* -imultiarch */
  OPT_imultilib = 1878,                      /* -imultilib */
  OPT_include = 1879,                        /* -include */
  OPT_iplugindir_ = 1880,                    /* -iplugindir= */
  OPT_iprefix = 1881,                        /* -iprefix */
  OPT_iquote = 1882,                         /* -iquote */
  OPT_isysroot = 1883,                       /* -isysroot */
  OPT_isystem = 1884,                        /* -isystem */
  OPT_iwithprefix = 1885,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1886,              /* -iwithprefixbefore */
  OPT_k8 = 1887,                             /* -k8 */
  OPT_l = 1888,                              /* -l */
  OPT_lang_asm = 1889,                       /* -lang-asm */
  OPT_list = 1890,                           /* -list */
  OPT_m128bit_long_double = 1891,            /* -m128bit-long-double */
  OPT_m16 = 1892,                            /* -m16 */
  OPT_m32 = 1893,                            /* -m32 */
  OPT_m3dnow = 1894,                         /* -m3dnow */
  OPT_m3dnowa = 1895,                        /* -m3dnowa */
  OPT_m64 = 1896,                            /* -m64 */
  OPT_m80387 = 1897,                         /* -m80387 */
  OPT_m8bit_idiv = 1898,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1899,             /* -m96bit-long-double */
  OPT_mabi_ = 1900,                          /* -mabi= */
  OPT_mabm = 1901,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1902,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1903,                 /* -maddress-mode= */
  OPT_madx = 1904,                           /* -madx */
  OPT_maes = 1905,                           /* -maes */
  OPT_malign_data_ = 1906,                   /* -malign-data= */
  OPT_malign_double = 1907,                  /* -malign-double */
  OPT_malign_functions_ = 1908,              /* -malign-functions= */
  OPT_malign_jumps_ = 1909,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1910,                  /* -malign-loops= */
  OPT_malign_stringops = 1911,               /* -malign-stringops */
  OPT_malign_vector_insn = 1912,             /* -malign-vector-insn */
  ...
  OPT_march_ = 1918,                         /* -march= */
  OPT_masm_ = 1919,                          /* -masm= */
  OPT_mavx = 1920,                           /* -mavx */
  OPT_mavx2 = 1921,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1922,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1923,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1924,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1925,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1926,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1927,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1928,                      /* -mavx512bw */
  OPT_mavx512cd = 1929,                      /* -mavx512cd */
  OPT_mavx512dq = 1930,                      /* -mavx512dq */
  OPT_mavx512er = 1931,                      /* -mavx512er */
  OPT_mavx512f = 1932,                       /* -mavx512f */
  OPT_mavx512fp16 = 1933,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1934,                    /* -mavx512ifma */
  OPT_mavx512pf = 1935,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1936,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1937,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1938,                      /* -mavx512vl */
  OPT_mavx512vnni = 1939,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1940,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1941,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1942,                       /* -mavxifma */
  OPT_mavxneconvert = 1943,                  /* -mavxneconvert */
  OPT_mavxvnni = 1944,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1945,                   /* -mavxvnniint8 */
  OPT_mbmi = 1946,                           /* -mbmi */
  OPT_mbmi2 = 1947,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1948,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1949,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1950,                    /* -mcet-switch */
  OPT_mcld = 1951,                           /* -mcld */
  OPT_mcldemote = 1952,                      /* -mcldemote */
  OPT_mclflushopt = 1953,                    /* -mclflushopt */
  OPT_mclwb = 1954,                          /* -mclwb */
  OPT_mclzero = 1955,                        /* -mclzero */
  OPT_mcmodel_ = 1956,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1957,                     /* -mcmpccxadd */
  OPT_mconsole = 1958,                       /* -mconsole */
  /* OPT_mcpu_ = 1959, */                    /* -mcpu= */
  OPT_mcrc32 = 1960,                         /* -mcrc32 */
  OPT_mcrtdll_ = 1961,                       /* -mcrtdll= */
  ...
  OPT_mdll = 1966,                           /* -mdll */
  OPT_mdump_tune_features = 1967,            /* -mdump-tune-features */
  OPT_menqcmd = 1968,                        /* -menqcmd */
  OPT_mf16c = 1969,                          /* -mf16c */
  OPT_mfancy_math_387 = 1970,                /* -mfancy-math-387 */
  OPT_mfentry = 1971,                        /* -mfentry */
  OPT_mfentry_name_ = 1972,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1973,               /* -mfentry-section= */
  OPT_mfma = 1974,                           /* -mfma */
  OPT_mfma4 = 1975,                          /* -mfma4 */
  OPT_mforce_drap = 1976,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1977,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1978,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1979,                       /* -mfpmath= */
  OPT_mfsgsbase = 1980,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1981,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1982, */              /* -mfused-madd */
  OPT_mfxsr = 1983,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1984,             /* -mgeneral-regs-only */
  OPT_mgfni = 1985,                          /* -mgfni */
  OPT_mhard_float = 1986,                    /* -mhard-float */
  OPT_mharden_sls_ = 1987,                   /* -mharden-sls= */
  OPT_mhle = 1988,                           /* -mhle */
  OPT_mhreset = 1989,                        /* -mhreset */
  OPT_miamcu = 1990,                         /* -miamcu */
  OPT_mieee_fp = 1991,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1992,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1993,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1994,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1995,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1996,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1997,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1998,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1999, */            /* -mintel-syntax */
  OPT_mkl = 2000,                            /* -mkl */
  OPT_mlam_ = 2001,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2002,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2003,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2004,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2005,                /* -mlong-double-80 */
  OPT_mlwp = 2006,                           /* -mlwp */
  OPT_mlzcnt = 2007,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2008,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2009,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2010,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2011,                  /* -mmitigate-rop */
  OPT_mmmx = 2012,                           /* -mmmx */
  OPT_mmovbe = 2013,                         /* -mmovbe */
  OPT_mmovdir64b = 2014,                     /* -mmovdir64b */
  OPT_mmovdiri = 2015,                       /* -mmovdiri */
  OPT_mmove_max_ = 2016,                     /* -mmove-max= */
  OPT_mmpx = 2017,                           /* -mmpx */
  OPT_mms_bitfields = 2018,                  /* -mms-bitfields */
  OPT_mmwait = 2019,                         /* -mmwait */
  OPT_mmwaitx = 2020,                        /* -mmwaitx */
  OPT_mneeded = 2021,                        /* -mneeded */
  OPT_mno_align_stringops = 2022,            /* -mno-align-stringops */
  OPT_mno_align_vector_insn = 2023,          /* -mno-align-vector-insn */
  OPT_mno_default = 2024,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2025,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2026,                  /* -mno-push-args */
  OPT_mno_red_zone = 2027,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2028,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 2029,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 2038,            /* -mpe-aligned-commons */
  OPT_mpku = 2039,                           /* -mpku */
  OPT_mpopcnt = 2040,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2041, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2042,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2043,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2044,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2045,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2046,                        /* -mprfchw */
  OPT_mptwrite = 2047,                       /* -mptwrite */
  OPT_mpush_args = 2048,                     /* -mpush-args */
  OPT_mraoint = 2049,                        /* -mraoint */
  OPT_mrdpid = 2050,                         /* -mrdpid */
  OPT_mrdrnd = 2051,                         /* -mrdrnd */
  OPT_mrdseed = 2052,                        /* -mrdseed */
  OPT_mrecip = 2053,                         /* -mrecip */
  OPT_mrecip_ = 2054,                        /* -mrecip= */
  OPT_mrecord_mcount = 2055,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2056,                 /* -mrecord-return */
  OPT_mred_zone = 2057,                      /* -mred-zone */
  OPT_mregparm_ = 2058,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2059,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2060,                           /* -mrtd */
  OPT_mrtm = 2061,                           /* -mrtm */
  OPT_msahf = 2062,                          /* -msahf */
  ...
  OPT_mstv = 2088,                           /* -mstv */
  OPT_mtbm = 2089,                           /* -mtbm */
  OPT_mthreads = 2090,                       /* -mthreads */
  OPT_mtls_dialect_ = 2091,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2092,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2093,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2094,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2095,                         /* -mtune= */
  OPT_muintr = 2096,                         /* -muintr */
  OPT_municode = 2097,                       /* -municode */
  OPT_munroll_only_small_loops = 2098,       /* -munroll-only-small-loops */
  OPT_muse_libstdc_wrappers = 2099,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 2100,                          /* -mvaes */
  OPT_mveclibabi_ = 2101,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2102,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2103,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2104,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2105,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2106,                      /* -mwbnoinvd */
  OPT_mwidekl = 2107,                        /* -mwidekl */
  OPT_mwin32 = 2108,                         /* -mwin32 */
  OPT_mwindows = 2109,                       /* -mwindows */
  OPT_mx32 = 2110,                           /* -mx32 */
  OPT_mxop = 2111,                           /* -mxop */
  OPT_mxsave = 2112,                         /* -mxsave */
  OPT_mxsavec = 2113,                        /* -mxsavec */
  OPT_mxsaveopt = 2114,                      /* -mxsaveopt */
  OPT_mxsaves = 2115,                        /* -mxsaves */
  OPT_n = 2116,                              /* -n */
  OPT_name_sort = 2117,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2118,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2119,              /* -no-integrated-cpp */
  OPT_no_pie = 2120,                         /* -no-pie */
  OPT_no_pthread = 2121,                     /* -no-pthread */
  OPT_nocpp = 2122,                          /* -nocpp */
  OPT_nodefaultlibs = 2123,                  /* -nodefaultlibs */
  OPT_nolibc = 2124,                         /* -nolibc */
  OPT_nophoboslib = 2125,                    /* -nophoboslib */
  OPT_nostartfiles = 2126,                   /* -nostartfiles */
  OPT_nostdinc = 2127,                       /* -nostdinc */
  OPT_nostdinc__ = 2128,                     /* -nostdinc++ */
  OPT_nostdlib = 2129,                       /* -nostdlib */
  OPT_nostdlib__ = 2130,                     /* -nostdlib++ */
  OPT_o = 2131,                              /* -o */
  OPT_objects = 2132,                        /* -objects */
  OPT_p = 2133,                              /* -p */
  OPT_pass_exit_codes = 2134,                /* -pass-exit-codes */
  /* OPT_pedantic = 2135, */                 /* -pedantic */
  OPT_pedantic_errors = 2136,                /* -pedantic-errors */
  OPT_pg = 2137,                             /* -pg */
  OPT_pie = 2138,                            /* -pie */
  OPT_pipe = 2139,                           /* -pipe */
  OPT_posix = 2140,                          /* -posix */
  OPT_print_file_name_ = 2141,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2142,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2143,          /* -print-multi-directory */
  OPT_print_multi_lib = 2144,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2145,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2146,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2147,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2148,               /* -print-prog-name= */
  OPT_print_search_dirs = 2149,              /* -print-search-dirs */
  OPT_print_sysroot = 2150,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2151,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2152,                    /* -print-value */
  OPT_pthread = 2153,                        /* -pthread */
  OPT_quiet = 2154,                          /* -quiet */
  OPT_r = 2155,                              /* -r */
  OPT_remap = 2156,                          /* -remap */
  OPT_reverse_sort = 2157,                   /* -reverse-sort */
  OPT_s = 2158,                              /* -s */
  OPT_save_temps = 2159,                     /* -save-temps */
  OPT_save_temps_ = 2160,                    /* -save-temps= */
  OPT_shared = 2161,                         /* -shared */
  OPT_shared_libgcc = 2162,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2163,               /* -shared-libphobos */
  OPT_size_sort = 2164,                      /* -size-sort */
  /* OPT_specs = 2165, */                    /* -specs */
  OPT_specs_ = 2166,                         /* -specs= */
  OPT_static = 2167,                         /* -static */
  OPT_static_libasan = 2168,                 /* -static-libasan */
  OPT_static_libgcc = 2169,                  /* -static-libgcc */
  OPT_static_libgfortran = 2170,             /* -static-libgfortran */
  OPT_static_libgm2 = 2171,                  /* -static-libgm2 */
  OPT_static_libgo = 2172,                   /* -static-libgo */
  OPT_static_libhwasan = 2173,               /* -static-libhwasan */
  OPT_static_liblsan = 2174,                 /* -static-liblsan */
  OPT_static_libmpx = 2175,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2176,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2177,               /* -static-libphobos */
  OPT_static_libquadmath = 2178,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2179,               /* -static-libstdc++ */
  OPT_static_libtsan = 2180,                 /* -static-libtsan */
  OPT_static_libubsan = 2181,                /* -static-libubsan */
  OPT_static_pie = 2182,                     /* -static-pie */
  /* OPT_std_c__03 = 2183, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2184, */                /* -std=c++0x */
  OPT_std_c__11 = 2185,                      /* -std=c++11 */
  OPT_std_c__14 = 2186,                      /* -std=c++14 */
  OPT_std_c__17 = 2187,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2188, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2189, */                /* -std=c++1z */
  OPT_std_c__20 = 2190,                      /* -std=c++20 */
  OPT_std_c__23 = 2191,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2192, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2193, */                /* -std=c++2b */
  OPT_std_c__98 = 2194,                      /* -std=c++98 */
  OPT_std_c11 = 2195,                        /* -std=c11 */
  OPT_std_c17 = 2196,                        /* -std=c17 */
  /* OPT_std_c18 = 2197, */                  /* -std=c18 */
  /* OPT_std_c1x = 2198, */                  /* -std=c1x */
  OPT_std_c2x = 2199,                        /* -std=c2x */
  /* OPT_std_c89 = 2200, */                  /* -std=c89 */
  OPT_std_c90 = 2201,                        /* -std=c90 */
  OPT_std_c99 = 2202,                        /* -std=c99 */
  /* OPT_std_c9x = 2203, */                  /* -std=c9x */
  OPT_std_f2003 = 2204,                      /* -std=f2003 */
  OPT_std_f2008 = 2205,                      /* -std=f2008 */
  OPT_std_f2008ts = 2206,                    /* -std=f2008ts */
  OPT_std_f2018 = 2207,                      /* -std=f2018 */
  OPT_std_f95 = 2208,                        /* -std=f95 */
  OPT_std_gnu = 2209,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2210, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2211, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2212,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2213,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2214,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2215, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2216, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2217,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2218,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2219, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2220, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2221,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2222,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2223,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2224, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2225, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2226,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2227, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2228,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2229,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2230, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2231, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2232,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2233, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2234, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2235, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2236, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2237, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2238,                     /* -std=legacy */
  OPT_stdlib_ = 2239,                        /* -stdlib= */
  OPT_symbol_ = 2240,                        /* -symbol= */
  OPT_symbolic = 2241,                       /* -symbolic */
  OPT_t = 2242,                              /* -t */
  OPT_time = 2243,                           /* -time */
  OPT_time_ = 2244,                          /* -time= */
  OPT_traditional = 2245,                    /* -traditional */
  OPT_traditional_cpp = 2246,                /* -traditional-cpp */
  OPT_tree_stats = 2247,                     /* -tree-stats */
  OPT_trigraphs = 2248,                      /* -trigraphs */
  OPT_type_stats = 2249,                     /* -type-stats */
  OPT_u = 2250,                              /* -u */
  OPT_undef = 2251,                          /* -undef */
  OPT_v = 2252,                              /* -v */
  OPT_version = 2253,                        /* -version */
  OPT_w = 2254,                              /* -w */
  OPT_wrapper = 2255,                        /* -wrapper */
  OPT_x = 2256,                              /* -x */
  OPT_z = 2257,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
