...
# build directory.
itcl_BUILD_LIB_SPEC='-L/mingw32/lib/itcl4.0.5 -litcl405'
ITCL_BUILD_LIB_SPEC='-L/mingw32/lib/itcl4.0.5 -litcl405'

# String to pass to linker to pick up the Itcl library from its
# installed directory.
itcl_LIB_SPEC='-LC:/building/msys64/mingw32/lib/itcl4.0.5 -litcl405'
ITCL_LIB_SPEC='-LC:/building/msys64/mingw32/lib/itcl4.0.5 -litcl405'
...
# build directory.
itcl_BUILD_STUB_LIB_SPEC='-L/mingw32/lib/itcl4.0.5 -litclstub405'
ITCL_BUILD_STUB_LIB_SPEC='-L/mingw32/lib/itcl4.0.5 -litclstub405'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_SPEC='-LC:/building/msys64/mingw32/lib/itcl4.0.5 -litclstub405'
ITCL_STUB_LIB_SPEC='-LC:/building/msys64/mingw32/lib/itcl4.0.5 -litclstub405'

# String to pass to linker to pick up the Itcl stub library from its
# build directory.
itcl_BUILD_STUB_LIB_PATH='/mingw32/lib/itcl4.0.5/libitclstub405.a'
ITCL_BUILD_STUB_LIB_PATH='/mingw32/lib/itcl4.0.5/libitclstub405.a'

# String to pass to linker to pick up the Itcl stub library from its
# installed directory.
itcl_STUB_LIB_PATH='C:/building/msys64/mingw32/lib/itcl4.0.5/libitclstub405.a'
ITCL_STUB_LIB_PATH='C:/building/msys64/mingw32/lib/itcl4.0.5/libitclstub405.a'
