...
:FINISH
@ECHO Wrapping up: re-install mingw-w64-ucrt-x86_64-git-extra
@pacman -S --noconfirm mingw-w64-ucrt-x86_64-git-extra
@ECHO End of re-install of mingw-w64-ucrt-x86_64-git-extra
@ECHO ==
@IF ERRORLEVEL 1 GOTO DIE
